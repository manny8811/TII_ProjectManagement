...
*/var sr,bE;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(g,m){function v(){}v.prototype=m.prototype,g.F=m.prototype,g.prototype=new v,g.prototype.constructor=g,g.D=function(E,I,C){for(var T=Array(arguments.length-2),Ne=2;Ne<arguments.length;Ne++)T[Ne-2]=arguments[Ne];return m.prototype[I].apply(E,T)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(g,m,v){v||(v=0);const E=Array(16);if(typeof m=="string")for(var I=0;I<16;++I)E[I]=m.charCodeAt(v++)|m.charCodeAt(v++)<<8|m.charCodeAt(v++)<<16|m.charCodeAt(v++)<<24;else for(I=0;I<16;++I)E[I]=m[v++]|m[v++]<<8|m[v++]<<16|m[v++]<<24;m=g.g[0],v=g.g[1],I=g.g[2];let C=g.g[3],T;T=m+(C^v&(I^C))+E[0]+3614090360&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[1]+3905402710&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[2]+606105819&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[3]+3250441966&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(C^v&(I^C))+E[4]+4118548399&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[5]+1200080426&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[6]+2821735955&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[7]+4249261313&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(C^v&(I^C))+E[8]+1770035416&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[9]+2336552879&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[10]+4294925233&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[11]+2304563134&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(C^v&(I^C))+E[12]+1804603682&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[13]+4254626195&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[14]+2792965006&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[15]+1236535329&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(I^C&(v^I))+E[1]+4129170786&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^I&(m^v))+E[6]+3225465664&4294967295,C=m+(T<<9&4294967295|T>>>23),T=I+(m^v&(C^m))+E[11]+643717713&4294967295,I=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(I^C))+E[0]+3921069994&4294967295,v=I+(T<<20&4294967295|T>>>12),T=m+(I^C&(v^I))+E[5]+3593408605&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^I&(m^v))+E[10]+38016083&4294967295,C=m+(T<<9&4294967295|T>>>23),T=I+(m^v&(C^m))+E[15]+3634488961&4294967295,I=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(I^C))+E[4]+3889429448&4294967295,v=I+(T<<20&4294967295|T>>>12),T=m+(I^C&(v^I))+E[9]+568446438&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^I&(m^v))+E[14]+3275163606&4294967295,C=m+(T<<9&4294967295|T>>>23),T=I+(m^v&(C^m))+E[3]+4107603335&4294967295,I=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(I^C))+E[8]+1163531501&4294967295,v=I+(T<<20&4294967295|T>>>12),T=m+(I^C&(v^I))+E[13]+2850285829&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v
);const v=m-this.blockSize,E=this.C;let I=this.h,C=0;for(;C<m;){if(I==0)for(;C<=v;)i(this,g,C),C+=this.blockSize;if(typeof g=="string"){for(;C<m;)if(E[I++]=g.charCodeAt(C++),I==this.blockSize){i(this,E),I=0;break}}else for(;C<m;)if(E[I++]=g[C++],I==this.blockSize){i(this,E),I=0;break}}this.h=I,this.o+=m},r.prototype.A=function(){var g=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);g[0]=128;for(var m=1;m<g.length-8;++m)g[m]=0;m=this.o*8;for(var v=g.length-8;v<g.length;++v)g[v]=m&255,m/=256;for(this.v(g),g=Array(16),m=0,v=0;v<4;++v)for(let E=0;E<32;E+=8)g[m++]=this.g[v]>>>E&255;return g};function s(g,m){var v=l;return Object.prototype.hasOwnProperty.call(v,g)?v[g]:v[g]=m(g)}function o(g,m){this.h=m;const v=[];let E=!0;for(let I=g.length-1;I>=0;I--){const C=g[I]|0;E&&C==m||(v[I]=C,E=!1)}this.g=v}var l={};function u(g){return-128<=g&&g<128?s(g,function(m){return new o([m|0],m<0?-1:0)}):new o([g|0],g<0?-1:0)}function h(g){if(isNaN(g)||!isFinite(g))return p;if(g<0)return L(h(-g));const m=[];let v=1;for(let E=0;g>=v;E++)m[E]=g/v|0,v*=4294967296;return new o(m,0)}function f(g,m){if(g.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(g.charAt(0)=="-")return L(f(g.substring(1),m));if(g.indexOf("-")>=0)throw Error('number format error: interior "-" character');const v=h(Math.pow(m,8));let E=p;for(let C=0;C<g.length;C+=8){var I=Math.min(8,g.length-C);const T=parseInt(g.substring(C,C+I),m);I<8?(I=h(Math.pow(m,I)),E=E.j(I).add(h(T))):(E=E.j(v),E=E.add(h(T)))}return E}var p=u(0),_=u(1),A=u(16777216);t=o.prototype,t.m=function(){if(D(this))return-L(this).m();let g=0,m=1;for(let v=0;v<this.g.length;v++){const E=this.i(v);g+=(E>=0?E:4294967296+E)*m,m*=4294967296}return g},t.toString=function(g){if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(k(this))return"0";if(D(this))return"-"+L(this).toString(g);const m=h(Math.pow(g,6));var v=this;let E="";for(;;){const I=x(v,m).g;v=S(v,I.j(m));let C=((v.g.length>0?v.g[0]:v.h)>>>0).toString(g);if(v=I,k(v))return C+E;for(;C.length<6;)C="0"+C;E=C+E}},t.i=function(g){return g<0?0:g<this.g.length?this.g[g]:this.h};function k(g){if(g.h!=0)return!1;for(let m=0;m<g.g.length;m++)if(g.g[m]!=0)return!1;return!0}function D(g){return g.h==-1}t.l=function(g){return g=S(this,g),D(g)?-1:k(g)?0:1};function L(g){const m=g.g.length,v=[];for(let E=0;E<m;E++)v[E]=~g.g[E];return new o(v,~g.h).add(_)}t.abs=function(){return D(this)?L(this):this},t.add=function(g){const m=Math.max(this.g.length,g.g.length),v=[];let E=0;for(let I=0;I<=m;I++){let C=E+(this.i(I)&65535)+(g.i(I)&65535),T=(C>>>16)+(this.i(I)>>>16)+(g.i(I)>>>16);E=T>>>16,C&=65535,T&=65535,v[I]=T<<16|C}return new o(v,v[v.length-1]&-2147483648?-1:0)};function S(g,m){return g.add(L(m))}t.j=function(g){if(k(this)||k(g))return p;if(D(this))return D(g)?L(this).j(L(g)):L(L(this).j(g));if(D(g))return L(this.j(L(g)));if(this.l(A)<0&&g.l(A)<0)return h(this.m()*g.m());const m=this.g.length+g.g.length,v=[];for(var E=0;E<2*m;E++)v[E]=0;for(E=0;E<this.g.length;E++)for(let I=0;I<g.g.length;I++){const C=this.i(E)>>>16,T=this.i(E)&65535,Ne=g.i(I)>>>16,Ot=g.i(I)&65535;v[2*E+2*I]+=T*Ot,w(v,2*E+2*I),v[2*E+2*I+1]+=C*Ot,w(v,2*E+2*I+1),v[2*E+2*I+1]+=T*Ne,w(v,2*E+2*I+1),v[2*E+2*I+2]+=C*Ne,w(v,2*E+2*I+2)}for(g=0;g<m;g++)v[g]=v[2*g+1]<<16|v[2*g];for(g=m;g<2*m;g++)v[g]=0;return new o(v,0)};function w(g,m){for(;(g[m]&65535)!=g[m];)g[m+1]+=g[m]>>>16,g[m]&=65535,m++}function R(g,m){this.g=g,this.h=m}function x(g,m){if(k(m))throw Error("division by zero");if(k(g))return new R(p,p);if(D(g))return m=x(L(g),m),new R(L(m.g),L(m.h));if(D(m))return m=x(g,L(m)),new R(L(m.g),m.h);if(g.g.length>30){if(D(g)||D(m))throw Error("slowDivide_ only works with positive integers.");for(var v=_,E=m;E.l(g)<=0;)v=U(v),E=U(E);var I=j(v,1),C=j(E,1);for(E=j(E,2),v=j(v,2);!k(E);){var T=C.add(E);T.l(g)<=0&&(I=I.add(v),C=T),E=j(E,1),v=j(v,1)}return m=S(g,I.j(m)),new R(I,m)}for(I=p;g.l(m)>=0;){for(v=Math.max(1,Math.floor(g.m()/m.m())),E=Math.ceil(Math.log(v)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),C=h(v),T=C.j(m);D(T)||T.l(g)>0;)v-=E,C=h(v),T=C.j(m);k(C)&&(C=_),I=I.add(C),g=S(g,T)}return new R(I,g)}t.B=function(g){return x(this,g).h},t.and=function(g){const m=Math.max(this.g.length,g.g.length),v=[];for(let E=0;E<m;E++)v[E]=this.i(E)&g.i(E);return new o(v,this.h&g.h)},t.or=function(g){const m=Math.max(this.g.length,g.g.length),v=[];for(let E=0;E<m;E++)v[E]=this.i(E)|g.i(E);return new o(v,this.h|g.h)},t.xor=function(g){const m=Math.max(this.g.length,g.g.length),v=[];for(let E=0;E<m;E++)v[E]=this.i(E)^g.i(E);return new o(v,this.h^g.h)};function U(g){const m=g.g.length+1,v=[];for(let E=0;E<m;E++)v[E]=g.i(E)<<1|g.i(E-1)>>>31;return new o(v,g.h)}function j(g,m){const v=m>>5;m%=32;const E=g.g.length-v,I=[];for(let C=0;C<E;C++)I[C]=m>0?g.i(C+v)>>>m|g.i(C+v+1)<<32-m:g.i(C+v);return new o(I,g.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,bE=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,sr=o}).apply(typeof Ig<"u"?Ig:typeof self<"u"?self:typeof window<"u"?window:{});var Ra=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
