 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(B,K){var X=B.length;B.push(K);e:for(;0<X;){var pe=X-1>>>1,Ie=B[pe];if(0<i(Ie,K))B[pe]=K,B[X]=Ie,X=pe;else break e}}function n(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var K=B[0],X=B.pop();if(X!==K){B[0]=X;e:for(var pe=0,Ie=B.length,Sr=Ie>>>1;pe<Sr;){var It=2*(pe+1)-1,Ar=B[It],Lt=It+1,Cn=B[Lt];if(0>i(Ar,X))Lt<Ie&&0>i(Cn,Ar)?(B[pe]=Cn,B[Lt]=X,pe=Lt):(B[pe]=Ar,B[It]=X,pe=It);else if(Lt<Ie&&0>i(Cn,X))B[pe]=Cn,B[Lt]=X,pe=Lt;else break e}}return K}function i(B,K){var X=B.sortIndex-K.sortIndex;return X!==0?X:B.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,p=null,_=3,A=!1,k=!1,D=!1,L=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function R(B){for(var K=n(h);K!==null;){if(K.callback===null)r(h);else if(K.startTime<=B)r(h),K.sortIndex=K.expirationTime,e(u,K);else break;K=n(h)}}function x(B){if(D=!1,R(B),!k)if(n(u)!==null)k=!0,as(U);else{var K=n(h);K!==null&&ls(x,K.startTime-B)}}function U(B,K){k=!1,D&&(D=!1,S(m),m=-1),A=!0;var X=_;try{for(R(K),p=n(u);p!==null&&(!(p.expirationTime>K)||B&&!I());){var pe=p.callback;if(typeof pe=="function"){p.callback=null,_=p.priorityLevel;var Ie=pe(p.expirationTime<=K);K=t.unstable_now(),typeof Ie=="function"?p.callback=Ie:p===n(u)&&r(u),R(K)}else r(u);p=n(u)}if(p!==null)var Sr=!0;else{var It=n(h);It!==null&&ls(x,It.startTime-K),Sr=!1}return Sr}finally{p=null,_=X,A=!1}}var j=!1,y=null,m=-1,v=5,E=-1;function I(){return!(t.unstable_now()-E<v)}function C(){if(y!==null){var B=t.unstable_now();E=B;var K=!0;try{K=y(!0,B)}finally{K?T():(j=!1,y=null)}}else j=!1}var T;if(typeof w=="function")T=function(){w(C)};else if(typeof MessageChannel<"u"){var Ne=new MessageChannel,Ot=Ne.port2;Ne.port1.onmessage=C,T=function(){Ot.postMessage(null)}}else T=function(){L(C,0)};function as(B){y=B,j||(j=!0,T())}function ls(B,K){m=L(function(){B(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(B){B.callback=null},t.unstable_continueExecution=function(){k||A||(k=!0,as(U))},t.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):v=0<B?Math.floor(1e3/B):5},t.unstable_getCurrentPriorityLevel=function(){return _},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(B){switch(_){case 1:case 2:case 3:var K=3;break;default:K=_}var X=_;_=K;try{return B()}finally{_=X}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(B,K){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var X=_;_=B;try{return K()}finally{_=X}},t.unstable_scheduleCallback=function(B,K,X){var pe=t.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?pe+X:pe):X=pe,B){case 1:var Ie=-1;break;case 2:Ie=250;break;case 5:Ie=1073741823;break;case 4:Ie=1e4;break;default:Ie=5e3}return Ie=X+Ie,B={id:f++,callback:K,priorityLevel:B,startTime:X,expirationTime:Ie,sortIndex:-1},X>pe?(B.sortIndex=X,e(h,B),n(u)===null&&B===n(h)&&(D?(S(m),m=-1):D=!0,ls(x,X-pe))):(B.sortIndex=Ie,e(u,B),k||A||(k=!0,as(U))),B},t.unstable_shouldYield=I,t.unstable_wrapCallback=function(B){var K=_;return function(){var X=_;_=K;try{return B.apply(this,arguments)}finally{_=X}}}})($y);By.exports=$y;var gI=By.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DS(t,e){if(t.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n={alg:"none",type:"JWT"},r=e||"demo-project",i=t.iat||0,s=t.sub||t.user_id;if(!s)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const o={iss:`https://securetoken.google.com/${r}`,aud:r,iat:i,exp:i+3600,auth_time:i,sub:s,user_id:s,firebase:{sign_in_provider:"custom",identities:{}},...t};return[Al(JSON.stringify(n)),Al(JSON.stringify(o)),""].join(".")}const eo={};function xS(){const t={prod:[],emulator:[]};for(const e of Object.keys(eo))eo[e]?t.emulator.push(e):t.prod.push(e);return t}function VS(t){let e=document.getElementById(t),n=!1;return e||(e=document.createElement("div"),e.setAttribute("id",t),n=!0),{created:n,element:e}}let Km=!1;function Yv(t,e){if(typeof window>"u"||typeof document>"u"||!Zi(window.location.host)||eo[t]===e||eo[t]||Km)return;eo[t]=e;function n(_){return`__firebase__banner__${_}`}const r="__firebase__banner",s=xS().prod.length>0;function o(){const _=document.getElementById(r);_&&_.remove()}function l(_){_.style.display="flex",_.style.background="#7faaf0",_.style.position="fixed",_.style.bottom="5px",_.style.left="5px",_.style.padding=".5em",_.style.borderRadius="5px",_.style.alignItems="center"}function u(_,A){_.setAttribute("width","24"),_.setAttribute("id",A),_.setAttribute("height","24"),_.setAttribute("viewBox","0 0 24 24"),_.setAttribute("fill","none"),_.style.marginLeft="-6px"}function h(){const _=document.createElement("span");return _.style.cursor="pointer",_.style.marginLeft="16px",_.style.fontSize="24px",_.innerHTML=" &times;",_.onclick=()=>{Km=!0,o()},_}function f(_,A){_.setAttribute("id",A),_.innerText="Learn more",_.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",_.setAttribute("target","__blank"),_.style.paddingLeft="5px",_.style.textDecoration="underline"}function p(){const _=VS(r),A=n("text"),k=document.getElementById(A)||document.createElement("span"),D=n("learnmore"),L=document.getElementById(D)||document.createElement("a"),S=n("preprendIcon"),w=document.getElementById(S)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(_.created){const R=_.element;l(R),f(L,D);const x=h();u(w,S),R.append(w,k,L,x),document.body.appendChild(R)}s?(k.innerText="Preview backend disconnected.",w.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $S="FirebaseError";class Rn extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=$S,Object.setPrototypeOf(this,Rn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Uo.prototype.create)}}class Uo{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},i=`${this.service}/${e}`,s=this.errors[e],o=s?HS(s,r):"Error",l=`${this.serviceName}: ${o} (${i}).`;return new Rn(i,l,r)}}function HS(t,e){return t.replace(qS,(n,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const qS=/\{\$([^}]+)}/g;function WS(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Wr(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const i of n){if(!r.includes(i))return!1;const s=t[i],o=e[i];if(Qm(s)&&Qm(o)){if(!Wr(s,o))return!1}else if(s!==o)return!1}for(const i of r)if(!n.includes(i))return!1;return!0}function Qm(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wn=new Qd("@firebase/app"),yA="@firebase/app-compat",_A="@firebase/analytics-compat",vA="@firebase/analytics",EA="@firebase/app-check-compat",wA="@firebase/app-check",TA="@firebase/auth",IA="@firebase/auth-compat",SA="@firebase/database",AA="@firebase/data-connect",RA="@firebase/database-compat",CA="@firebase/functions",PA="@firebase/functions-compat",kA="@firebase/installations",NA="@firebase/installations-compat",DA="@firebase/messaging",xA="@firebase/messaging-compat",VA="@firebase/performance",OA="@firebase/performance-compat",LA="@firebase/remote-config",MA="@firebase/remote-config-compat",bA="@firebase/storage",FA="@firebase/storage-compat",UA="@firebase/firestore",jA="@firebase/ai",zA="@firebase/firestore-compat",BA="firebase",$A="12.6.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KA="firebase-heartbeat-database",QA=1,So="firebase-heartbeat-store";let Cc=null;function tE(){return Cc||(Cc=dA(KA,QA,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(So)}catch(n){console.warn(n)}}}}).catch(t=>{throw rr.create("idb-open",{originalErrorMessage:t.message})})),Cc}async function YA(t){try{const n=(await tE()).transaction(So),r=await n.objectStore(So).get(nE(t));return await n.done,r}catch(e){if(e instanceof Rn)wn.warn(e.message);else{const n=rr.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});wn.warn(n.message)}}}async function tg(t,e){try{const r=(await tE()).transaction(So,"readwrite");await r.objectStore(So).put(e,nE(t)),await r.done}catch(n){if(n instanceof Rn)wn.warn(n.message);else{const r=rr.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});wn.warn(r.message)}}}function nE(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ir(i1,s1,"app");function rE(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const o1=rE,iE=new Uo("auth","Firebase",rE());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zo{constructor(e,n){this.shortDelay=e,this.longDelay=n,Tn(n>e,"Short delay should be less than long delay!"),this.isMobile=OS()||FS()}get(){return u1()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d1=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],f1=new zo(3e4,6e4);function Er(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function wr(t,e,n,r,i={}){return aE(t,i,async()=>{let s={},o={};r&&(e==="GET"?o=r:s={body:JSON.stringify(r)});const l=jo({key:t.config.apiKey,...o}).slice(1),u=await t._getAdditionalHeaders();u["Content-Type"]="application/json",t.languageCode&&(u["X-Firebase-Locale"]=t.languageCode);const h={method:e,headers:u,...s};return MS()||(h.referrerPolicy="no-referrer"),t.emulatorConfig&&Zi(t.emulatorConfig.host)&&(h.credentials="include"),oE.fetch()(await lE(t,t.config.apiHost,n,l),h)})}async function aE(t,e,n){t._canInitEmulator=!1;const r={...h1,...e};try{const i=new m1(t),s=await Promise.race([n(),i.promise]);i.clearNetworkTimeout();const o=await s.json();if("needConfirmation"in o)throw Ra(t,"account-exists-with-different-credential",o);if(s.ok&&!("errorMessage"in o))return o;{const l=s.ok?o.errorMessage:o.error.message,[u,h]=l.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ra(t,"credential-already-in-use",o);if(u==="EMAIL_EXISTS")throw Ra(t,"email-already-in-use",o);if(u==="USER_DISABLED")throw Ra(t,"user-disabled",o);const f=r[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(h)throw sE(t,f,h);Ht(t,f)}}catch(i){if(i instanceof Rn)throw i;Ht(t,"network-request-failed",{message:String(i)})}}async function Bo(t,e,n,r,i={}){const s=await wr(t,e,n,r,i);return"mfaPendingCredential"in s&&Ht(t,"multi-factor-auth-required",{_serverResponse:s}),s}async function lE(t,e,n,r){const i=`${e}${n}?${r}`,s=t,o=s.config.emulator?Zd(t.config,i):`${t.config.apiScheme}://${i}`;return d1.includes(n)&&(await s._persistenceManagerAvailable,s._getPersistenceType()==="COOKIE")?s._getPersistence()._getFinalTarget(o).toString():o}function p1(t){switch(t){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class m1{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(en(this.auth,"network-request-failed")),f1.get())})}}function Ra(t,e,n){const r={appName:t.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const i=en(t,e,r);return i.customData._tokenResponse=n,i}function sg(t){return t!==void 0&&t.enterprise!==void 0}class g1{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const n of this.recaptchaEnforcementState)if(n.provider&&n.provider===e)return p1(n.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}isAnyProviderEnabled(){return this.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")||this.isProviderEnabled("PHONE_PROVIDER")}}async function y1(t,e){return wr(t,"GET","/v2/recaptchaConfig",Er(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ao(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Rn&&E1(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function E1({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function S1(t,e){const n=await aE(t,{},async()=>{const r=jo({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:s}=t.config,o=await lE(t,i,"/v1/token",`key=${s}`),l=await t._getAdditionalHeaders();l["Content-Type"]="application/x-www-form-urlencoded";const u={method:"POST",headers:l,body:r};return t.emulatorConfig&&Zi(t.emulatorConfig.host)&&(u.credentials="include"),oE.fetch()(o,u)});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function A1(t,e){return wr(t,"POST","/v2/accounts:revokeToken",Er(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wa(t,e,n){return`firebase:${t}:${e}:${n}`}class xi{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Wa(this.userKey,i.apiKey,s),this.fullPersistenceKey=Wa("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const n=await Pl(this.auth,{idToken:e}).catch(()=>{});return n?jt._fromGetAccountInfoResponse(this.auth,n,e):null}return jt._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new xi(pn(lg),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||pn(lg);const o=Wa(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){let p;if(typeof f=="string"){const _=await Pl(e,{idToken:f}).catch(()=>{});if(!_)break;p=await jt._fromGetAccountInfoResponse(e,_,f)}else p=jt._fromJSON(e,f);h!==s&&(l=p),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new xi(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new xi(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z1(t,e){const n=Xd(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(Wr(s,e??{}))return i;Ht(i,"already-initialized")}return n.initialize({options:e})}function B1(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(pn);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function $1(t,e,n){const r=ei(t);W(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=TE(e),{host:o,port:l}=H1(e),u=l===null?"":`:${l}`,h={url:`${s}//${o}${u}/`},f=Object.freeze({host:o,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!r._canInitEmulator){W(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),W(Wr(h,r.config.emulator)&&Wr(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=h,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,Zi(o)?(Qv(`${s}//${o}${u}`),Yv("Auth",!0)):q1()}function TE(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function H1(t){const e=TE(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:dg(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:dg(o)}}}function dg(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function q1(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nf{constructor(e,n){this.providerId=e,this.signInMethod=n}toJSON(){return fn("not implemented")}_getIdTokenResponse(e){return fn("not implemented")}_linkToIdToken(e,n){return fn("not implemented")}_getReauthenticationResolver(e){return fn("not implemented")}}async function W1(t,e){return wr(t,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G1(t,e){return Bo(t,"POST","/v1/accounts:signInWithPassword",Er(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function K1(t,e){return Bo(t,"POST","/v1/accounts:signInWithEmailLink",Er(t,e))}async function Q1(t,e){return Bo(t,"POST","/v1/accounts:signInWithEmailLink",Er(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vi(t,e){return Bo(t,"POST","/v1/accounts:signInWithIdp",Er(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(){this.providerId=ts.PROVIDER_ID}static credential(e,n){return Ro._fromEmailAndPassword(e,n)}static credentialWithLink(e,n){const r=rf.parseLink(n);return W(r,"argument-error"),Ro._fromEmailAndCode(e,r.code,r.tenantId)}}ts.PROVIDER_ID="password";ts.EMAIL_PASSWORD_SIGN_IN_METHOD="password";ts.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $o extends IE{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn extends $o{constructor(){super("facebook.com")}static credential(e){return Kr._fromParams({providerId:zn.PROVIDER_ID,signInMethod:zn.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return zn.credentialFromTaggedObject(e)}static credentialFromError(e){return zn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return zn.credential(e.oauthAccessToken)}catch{return null}}}zn.FACEBOOK_SIGN_IN_METHOD="facebook.com";zn.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $n extends $o{constructor(){super("github.com")}static credential(e){return Kr._fromParams({providerId:$n.PROVIDER_ID,signInMethod:$n.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return $n.credentialFromTaggedObject(e)}static credentialFromError(e){return $n.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return $n.credential(e.oauthAccessToken)}catch{return null}}}$n.GITHUB_SIGN_IN_METHOD="github.com";$n.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Z1(t,e){return Bo(t,"POST","/v1/accounts:signUp",Er(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nl extends Rn{constructor(e,n,r,i){super(n.code,n.message),this.operationType=r,this.user=i,Object.setPrototypeOf(this,Nl.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:n.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,n,r,i){return new Nl(e,n,r,i)}}function SE(t,e,n,r){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(s=>{throw s.code==="auth/multi-factor-auth-required"?Nl._fromErrorAndOperation(t,s,e,r):s})}async function eR(t,e,n=!1){const r=await Ao(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Qr._forOperation(t,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tR(t,e,n=!1){const{auth:r}=t;if(Rt(r.app))return Promise.reject(gn(r));const i="reauthenticate";try{const s=await Ao(t,SE(r,i,e,t),n);W(s.idToken,r,"internal-error");const o=ef(s.idToken);W(o,r,"internal-error");const{sub:l}=o;return W(t.uid===l,r,"user-mismatch"),Qr._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&Ht(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function AE(t,e,n=!1){if(Rt(t.app))return Promise.reject(gn(t));const r="signIn",i=await SE(t,r,e),s=await Qr._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function nR(t,e){return AE(ei(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function RE(t){const e=ei(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function rR(t,e,n){if(Rt(t.app))return Promise.reject(gn(t));const r=ei(t),o=await Oh(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Z1).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&RE(t),u}),l=await Qr._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(l.user),l}function iR(t,e,n){return Rt(t.app)?Promise.reject(gn(t)):nR(Ue(t),ts.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&RE(t),r})}function sR(t,e,n,r){return Ue(t).onIdTokenChanged(e,n,r)}function oR(t,e,n){return Ue(t).beforeAuthStateChanged(e,n)}function aR(t){return Ue(t).signOut()}const Dl="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IR(t,e){return e?pn(e):(W(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LE{constructor(e,n,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:s,error:o,type:l}=e;if(o){this.reject(o);return}const u={auth:this.auth,requestUri:n,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(h){this.reject(h)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return SR;case"linkViaPopup":case"linkViaRedirect":return RR;case"reauthViaPopup":case"reauthViaRedirect":return AR;default:Ht(this.auth,"internal-error")}}resolve(e){Tn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Tn(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PR="pendingRedirect",Ga=new Map;class kR extends LE{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Ga.get(this.auth._key());if(!e){try{const r=await NR(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Ga.set(this.auth._key(),e)}return this.bypassAuthState||Ga.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function NR(t,e){const n=VR(e),r=xR(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function DR(t,e){Ga.set(t._key(),e)}function xR(t){return pn(t._redirectPersistence)}function VR(t){return Wa(PR,t.config.apiKey,t.name)}async function OR(t,e,n=!1){if(Rt(t.app))return Promise.reject(gn(t));const r=ei(t),i=IR(r,e),o=await new kR(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WR=new zo(5e3,15e3),GR="__/auth/iframe",KR="emulator/auth/iframe",QR={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},YR=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function XR(t){const e=t.config;W(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Zd(e,KR):`https://${t.config.authDomain}/${GR}`,r={apiKey:e.apiKey,appName:t.name,v:es},i=YR.get(t.config.apiHost);i&&(r.eid=i);const s=t._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${jo(r).slice(1)}`}async function JR(t){const e=await qR(t),n=tn().gapi;return W(n,t,"internal-error"),e.open({where:document.body,url:XR(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:QR,dontclear:!0},r=>new Promise(async(i,s)=>{await r.restyle({setHideOnLeave:!1});const o=en(t,"network-request-failed"),l=tn().setTimeout(()=>{s(o)},WR.get());function u(){tn().clearTimeout(l),i(r)}r.ping(u).then(u,()=>{s(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oC="__/auth/handler",aC="emulator/auth/handler",lC=encodeURIComponent("fac");async function vg(t,e,n,r,i,s){W(t.config.authDomain,t,"auth-domain-config-required"),W(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:es,eventId:i};if(e instanceof IE){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",WS(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof $o){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${lC}=${encodeURIComponent(u)}`:"";return`${uC(t)}?${jo(l).slice(1)}${h}`}function uC({config:t}){return t.emulator?Zd(t,aC):`https://${t.authDomain}/${oC}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var sr,bE;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(y,m){function v(){}v.prototype=m.prototype,y.F=m.prototype,y.prototype=new v,y.prototype.constructor=y,y.D=function(E,I,C){for(var T=Array(arguments.length-2),Ne=2;Ne<arguments.length;Ne++)T[Ne-2]=arguments[Ne];return m.prototype[I].apply(E,T)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(y,m,v){v||(v=0);const E=Array(16);if(typeof m=="string")for(var I=0;I<16;++I)E[I]=m.charCodeAt(v++)|m.charCodeAt(v++)<<8|m.charCodeAt(v++)<<16|m.charCodeAt(v++)<<24;else for(I=0;I<16;++I)E[I]=m[v++]|m[v++]<<8|m[v++]<<16|m[v++]<<24;m=y.g[0],v=y.g[1],I=y.g[2];let C=y.g[3],T;T=m+(C^v&(I^C))+E[0]+3614090360&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[1]+3905402710&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[2]+606105819&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[3]+3250441966&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(C^v&(I^C))+E[4]+4118548399&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[5]+1200080426&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[6]+2821735955&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[7]+4249261313&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(C^v&(I^C))+E[8]+1770035416&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[9]+2336552879&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[10]+4294925233&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[11]+2304563134&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(C^v&(I^C))+E[12]+1804603682&4294967295,m=v+(T<<7&4294967295|T>>>25),T=C+(I^m&(v^I))+E[13]+4254626195&4294967295,C=m+(T<<12&4294967295|T>>>20),T=I+(v^C&(m^v))+E[14]+2792965006&4294967295,I=C+(T<<17&4294967295|T>>>15),T=v+(m^I&(C^m))+E[15]+1236535329&4294967295,v=I+(T<<22&4294967295|T>>>10),T=m+(I^C&(v^I))+E[1]+4129170786&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^I&(m^v))+E[6]+3225465664&4294967295,C=m+(T<<9&4294967295|T>>>23),T=I+(m^v&(C^m))+E[11]+643717713&4294967295,I=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(I^C))+E[0]+3921069994&4294967295,v=I+(T<<20&4294967295|T>>>12),T=m+(I^C&(v^I))+E[5]+3593408605&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^I&(m^v))+E[10]+38016083&4294967295,C=m+(T<<9&4294967295|T>>>23),T=I+(m^v&(C^m))+E[15]+3634488961&4294967295,I=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(I^C))+E[4]+3889429448&4294967295,v=I+(T<<20&4294967295|T>>>12),T=m+(I^C&(v^I))+E[9]+568446438&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^I&(m^v))+E[14]+3275163606&4294967295,C=m+(T<<9&4294967295|T>>>23),T=I+(m^v&(C^m))+E[3]+4107603335&4294967295,I=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(I^C))+E[8]+1163531501&4294967295,v=I+(T<<20&4294967295|T>>>12),T=m+(I^C&(v^I))+E[13]+2850285829&4294967295,m=v+(T<<5&4294967295|T>>>27),T=C+(v^I&(m^v))+E[2]+4243563512&4294967295,C=m+(T<<9&4294967295|T>>>23),T=I+(m^v&(C^m))+E[7]+1735328473&4294967295,I=C+(T<<14&4294967295|T>>>18),T=v+(C^m&(I^C))+E[12]+2368359562&4294967295,v=I+(T<<20&4294967295|T>>>12),T=m+(v^I^C)+E[5]+4294588738&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^I)+E[8]+2272392833&4294967295,C=m+(T<<11&4294967295|T>>>21),T=I+(C^m^v)+E[11]+1839030562&4294967295,I=C+(T<<16&4294967295|T>>>16),T=v+(I^C^m)+E[14]+4259657740&4294967295,v=I+(T<<23&4294967295|T>>>9),T=m+(v^I^C)+E[1]+2763975236&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^I)+E[4]+1272893353&4294967295,C=m+(T<<11&4294967295|T>>>21),T=I+(C^m^v)+E[7]+4139469664&4294967295,I=C+(T<<16&4294967295|T>>>16),T=v+(I^C^m)+E[10]+3200236656&4294967295,v=I+(T<<23&4294967295|T>>>9),T=m+(v^I^C)+E[13]+681279174&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^I)+E[0]+3936430074&4294967295,C=m+(T<<11&4294967295|T>>>21),T=I+(C^m^v)+E[3]+3572445317&4294967295,I=C+(T<<16&4294967295|T>>>16),T=v+(I^C^m)+E[6]+76029189&4294967295,v=I+(T<<23&4294967295|T>>>9),T=m+(v^I^C)+E[9]+3654602809&4294967295,m=v+(T<<4&4294967295|T>>>28),T=C+(m^v^I)+E[12]+3873151461&4294967295,C=m+(T<<11&4294967295|T>>>21),T=I+(C^m^v)+E[15]+530742520&4294967295,I=C+(T<<16&4294967295|T>>>16),T=v+(I^C^m)+E[2]+3299628645&4294967295,v=I+(T<<23&4294967295|T>>>9),T=m+(I^(v|~C))+E[0]+4096336452&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~I))+E[7]+1126891415&4294967295,C=m+(T<<10&4294967295|T>>>22),T=I+(m^(C|~v))+E[14]+2878612391&4294967295,I=C+(T<<15&4294967295|T>>>17),T=v+(C^(I|~m))+E[5]+4237533241&4294967295,v=I+(T<<21&4294967295|T>>>11),T=m+(I^(v|~C))+E[12]+1700485571&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~I))+E[3]+2399980690&4294967295,C=m+(T<<10&4294967295|T>>>22),T=I+(m^(C|~v))+E[10]+4293915773&4294967295,I=C+(T<<15&4294967295|T>>>17),T=v+(C^(I|~m))+E[1]+2240044497&4294967295,v=I+(T<<21&4294967295|T>>>11),T=m+(I^(v|~C))+E[8]+1873313359&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~I))+E[15]+4264355552&4294967295,C=m+(T<<10&4294967295|T>>>22),T=I+(m^(C|~v))+E[6]+2734768916&4294967295,I=C+(T<<15&4294967295|T>>>17),T=v+(C^(I|~m))+E[13]+1309151649&4294967295,v=I+(T<<21&4294967295|T>>>11),T=m+(I^(v|~C))+E[4]+4149444226&4294967295,m=v+(T<<6&4294967295|T>>>26),T=C+(v^(m|~I))+E[11]+3174756917&4294967295,C=m+(T<<10&4294967295|T>>>22),T=I+(m^(C|~v))+E[2]+718787259&4294967295,I=C+(T<<15&4294967295|T>>>17),T=v+(C^(I|~m))+E[9]+3951481745&4294967295,y.g[0]=y.g[0]+m&4294967295,y.g[1]=y.g[1]+(I+(T<<21&4294967295|T>>>11))&4294967295,y.g[2]=y.g[2]+I&4294967295,y.g[3]=y.g[3]+C&4294967295}r.prototype.v=function(y,m){m===void 0&&(m=y.length);const v=m-this.blockSize,E=this.C;let I=this.h,C=0;for(;C<m;){if(I==0)for(;C<=v;)i(this,y,C),C+=this.blockSize;if(typeof y=="string"){for(;C<m;)if(E[I++]=y.charCodeAt(C++),I==this.blockSize){i(this,E),I=0;break}}else for(;C<m;)if(E[I++]=y[C++],I==this.blockSize){i(this,E),I=0;break}}this.h=I,this.o+=m},r.prototype.A=function(){var y=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);y[0]=128;for(var m=1;m<y.length-8;++m)y[m]=0;m=this.o*8;for(var v=y.length-8;v<y.length;++v)y[v]=m&255,m/=256;for(this.v(y),y=Array(16),m=0,v=0;v<4;++v)for(let E=0;E<32;E+=8)y[m++]=this.g[v]>>>E&255;return y};function s(y,m){var v=l;return Object.prototype.hasOwnProperty.call(v,y)?v[y]:v[y]=m(y)}function o(y,m){this.h=m;const v=[];let E=!0;for(let I=y.length-1;I>=0;I--){const C=y[I]|0;E&&C==m||(v[I]=C,E=!1)}this.g=v}var l={};function u(y){return-128<=y&&y<128?s(y,function(m){return new o([m|0],m<0?-1:0)}):new o([y|0],y<0?-1:0)}function h(y){if(isNaN(y)||!isFinite(y))return p;if(y<0)return L(h(-y));const m=[];let v=1;for(let E=0;y>=v;E++)m[E]=y/v|0,v*=4294967296;return new o(m,0)}function f(y,m){if(y.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(y.charAt(0)=="-")return L(f(y.substring(1),m));if(y.indexOf("-")>=0)throw Error('number format error: interior "-" character');const v=h(Math.pow(m,8));let E=p;for(let C=0;C<y.length;C+=8){var I=Math.min(8,y.length-C);const T=parseInt(y.substring(C,C+I),m);I<8?(I=h(Math.pow(m,I)),E=E.j(I).add(h(T))):(E=E.j(v),E=E.add(h(T)))}return E}var p=u(0),_=u(1),A=u(16777216);t=o.prototype,t.m=function(){if(D(this))return-L(this).m();let y=0,m=1;for(let v=0;v<this.g.length;v++){const E=this.i(v);y+=(E>=0?E:4294967296+E)*m,m*=4294967296}return y},t.toString=function(y){if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(k(this))return"0";if(D(this))return"-"+L(this).toString(y);const m=h(Math.pow(y,6));var v=this;let E="";for(;;){const I=x(v,m).g;v=S(v,I.j(m));let C=((v.g.length>0?v.g[0]:v.h)>>>0).toString(y);if(v=I,k(v))return C+E;for(;C.length<6;)C="0"+C;E=C+E}},t.i=function(y){return y<0?0:y<this.g.length?this.g[y]:this.h};function k(y){if(y.h!=0)return!1;for(let m=0;m<y.g.length;m++)if(y.g[m]!=0)return!1;return!0}function D(y){return y.h==-1}t.l=function(y){return y=S(this,y),D(y)?-1:k(y)?0:1};function L(y){const m=y.g.length,v=[];for(let E=0;E<m;E++)v[E]=~y.g[E];return new o(v,~y.h).add(_)}t.abs=function(){return D(this)?L(this):this},t.add=function(y){const m=Math.max(this.g.length,y.g.length),v=[];let E=0;for(let I=0;I<=m;I++){let C=E+(this.i(I)&65535)+(y.i(I)&65535),T=(C>>>16)+(this.i(I)>>>16)+(y.i(I)>>>16);E=T>>>16,C&=65535,T&=65535,v[I]=T<<16|C}return new o(v,v[v.length-1]&-2147483648?-1:0)};function S(y,m){return y.add(L(m))}t.j=function(y){if(k(this)||k(y))return p;if(D(this))return D(y)?L(this).j(L(y)):L(L(this).j(y));if(D(y))return L(this.j(L(y)));if(this.l(A)<0&&y.l(A)<0)return h(this.m()*y.m());const m=this.g.length+y.g.length,v=[];for(var E=0;E<2*m;E++)v[E]=0;for(E=0;E<this.g.length;E++)for(let I=0;I<y.g.length;I++){const C=this.i(E)>>>16,T=this.i(E)&65535,Ne=y.i(I)>>>16,Ot=y.i(I)&65535;v[2*E+2*I]+=T*Ot,w(v,2*E+2*I),v[2*E+2*I+1]+=C*Ot,w(v,2*E+2*I+1),v[2*E+2*I+1]+=T*Ne,w(v,2*E+2*I+1),v[2*E+2*I+2]+=C*Ne,w(v,2*E+2*I+2)}for(y=0;y<m;y++)v[y]=v[2*y+1]<<16|v[2*y];for(y=m;y<2*m;y++)v[y]=0;return new o(v,0)};function w(y,m){for(;(y[m]&65535)!=y[m];)y[m+1]+=y[m]>>>16,y[m]&=65535,m++}function R(y,m){this.g=y,this.h=m}function x(y,m){if(k(m))throw Error("division by zero");if(k(y))return new R(p,p);if(D(y))return m=x(L(y),m),new R(L(m.g),L(m.h));if(D(m))return m=x(y,L(m)),new R(L(m.g),m.h);if(y.g.length>30){if(D(y)||D(m))throw Error("slowDivide_ only works with positive integers.");for(var v=_,E=m;E.l(y)<=0;)v=U(v),E=U(E);var I=j(v,1),C=j(E,1);for(E=j(E,2),v=j(v,2);!k(E);){var T=C.add(E);T.l(y)<=0&&(I=I.add(v),C=T),E=j(E,1),v=j(v,1)}return m=S(y,I.j(m)),new R(I,m)}for(I=p;y.l(m)>=0;){for(v=Math.max(1,Math.floor(y.m()/m.m())),E=Math.ceil(Math.log(v)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),C=h(v),T=C.j(m);D(T)||T.l(y)>0;)v-=E,C=h(v),T=C.j(m);k(C)&&(C=_),I=I.add(C),y=S(y,T)}return new R(I,y)}t.B=function(y){return x(this,y).h},t.and=function(y){const m=Math.max(this.g.length,y.g.length),v=[];for(let E=0;E<m;E++)v[E]=this.i(E)&y.i(E);return new o(v,this.h&y.h)},t.or=function(y){const m=Math.max(this.g.length,y.g.length),v=[];for(let E=0;E<m;E++)v[E]=this.i(E)|y.i(E);return new o(v,this.h|y.h)},t.xor=function(y){const m=Math.max(this.g.length,y.g.length),v=[];for(let E=0;E<m;E++)v[E]=this.i(E)^y.i(E);return new o(v,this.h^y.h)};function U(y){const m=y.g.length+1,v=[];for(let E=0;E<m;E++)v[E]=y.i(E)<<1|y.i(E-1)>>>31;return new o(v,y.h)}function j(y,m){const v=m>>5;m%=32;const E=y.g.length-v,I=[];for(let C=0;C<E;C++)I[C]=m>0?y.i(C+v)>>>m|y.i(C+v+1)<<32-m:y.i(C+v);return new o(I,y.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,bE=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,sr=o}).apply(typeof Ig<"u"?Ig:typeof self<"u"?self:typeof window<"u"?window:{});var Ca=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var FE,js,UE,Qa,Mh,jE,zE,BE;(function(){var t,e=Object.defineProperty;function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Ca=="object"&&Ca];for(var c=0;c<a.length;++c){var d=a[c];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var r=n(this);function i(a,c){if(c)e:{var d=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var P=a[g];if(!(P in d))break e;d=d[P]}a=a[a.length-1],g=d[a],c=c(g),c!=g&&c!=null&&e(d,a,{configurable:!0,writable:!0,value:c})}}i("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(a){return a||function(c){var d=[],g;for(g in c)Object.prototype.hasOwnProperty.call(c,g)&&d.push([g,c[g]]);return d}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var s=s||{},o=this||self;function l(a){var c=typeof a;return c=="object"&&a!=null||c=="function"}function u(a,c,d){return a.call.apply(a.bind,arguments)}function h(a,c,d){return h=u,h.apply(null,arguments)}function f(a,c){var d=Array.prototype.slice.call(arguments,1);return function(){var g=d.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function p(a,c){function d(){}d.prototype=c.prototype,a.Z=c.prototype,a.prototype=new d,a.prototype.constructor=a,a.Ob=function(g,P,N){for(var F=Array(arguments.length-2),J=2;J<arguments.length;J++)F[J-2]=arguments[J];return c.prototype[P].apply(g,F)}}var _=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function A(a){const c=a.length;if(c>0){const d=Array(c);for(let g=0;g<c;g++)d[g]=a[g];return d}return[]}function k(a,c){for(let g=1;g<arguments.length;g++){const P=arguments[g];var d=typeof P;if(d=d!="object"?d:P?Array.isArray(P)?"array":d:"null",d=="array"||d=="object"&&typeof P.length=="number"){d=a.length||0;const N=P.length||0;a.length=d+N;for(let F=0;F<N;F++)a[d+F]=P[F]}else a.push(P)}}class D{constructor(c,d){this.i=c,this.j=d,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function L(a){o.setTimeout(()=>{throw a},0)}function S(){var a=y;let c=null;return a.g&&(c=a.g,a.g=a.g.next,a.g||(a.h=null),c.next=null),c}class w{constructor(){this.h=this.g=null}add(c,d){const g=R.get();g.set(c,d),this.h?this.h.next=g:this.g=g,this.h=g}}var R=new D(()=>new x,a=>a.reset());class x{constructor(){this.next=this.g=this.h=null}set(c,d){this.h=c,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let U,j=!1,y=new w,m=()=>{const a=Promise.resolve(void 0);U=()=>{a.then(v)}};function v(){for(var a;a=S();){try{a.h.call(a.g)}catch(d){L(d)}var c=R;c.j(a),c.h<100&&(c.h++,a.next=c.g,c.g=a)}j=!1}function E(){this.u=this.u,this.C=this.C}E.prototype.u=!1,E.prototype.dispose=function(){this.u||(this.u=!0,this.N())},E.prototype[Symbol.dispose]=function(){this.dispose()},E.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function I(a,c){this.type=a,this.g=this.target=c,this.defaultPrevented=!1}I.prototype.h=function(){this.defaultPrevented=!0};var C=function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,c=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};o.addEventListener("test",d,c),o.removeEventListener("test",d,c)}catch{}return a}();function T(a){return/^[\s\xa0]*$/.test(a)}function Ne(a,c){I.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,c)}p(Ne,I),Ne.prototype.init=function(a,c){const d=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=c,c=a.relatedTarget,c||(d=="mouseover"?c=a.fromElement:d=="mouseout"&&(c=a.toElement)),this.relatedTarget=c,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&Ne.Z.h.call(this)},Ne.prototype.h=function(){Ne.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Ot="closure_listenable_"+(Math.random()*1e6|0),as=0;function ls(a,c,d,g,P){this.listener=a,this.proxy=null,this.src=c,this.type=d,this.capture=!!g,this.ha=P,this.key=++as,this.da=this.fa=!1}function B(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function K(a,c,d){for(const g in a)c.call(d,a[g],g,a)}function X(a,c){for(const d in a)c.call(void 0,a[d],d,a)}function pe(a){const c={};for(const d in a)c[d]=a[d];return c}const Ie="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Sr(a,c){let d,g;for(let P=1;P<arguments.length;P++){g=arguments[P];for(d in g)a[d]=g[d];for(let N=0;N<Ie.length;N++)d=Ie[N],Object.prototype.hasOwnProperty.call(g,d)&&(a[d]=g[d])}}function It(a){this.src=a,this.g={},this.h=0}It.prototype.add=function(a,c,d,g,P){const N=a.toString();a=this.g[N],a||(a=this.g[N]=[],this.h++);const F=Lt(a,c,g,P);return F>-1?(c=a[F],d||(c.fa=!1)):(c=new ls(c,this.src,N,!!g,P),c.fa=d,a.push(c)),c};function Ar(a,c){const d=c.type;if(d in a.g){var g=a.g[d],P=Array.prototype.indexOf.call(g,c,void 0),N;(N=P>=0)&&Array.prototype.splice.call(g,P,1),N&&(B(c),a.g[d].length==0&&(delete a.g[d],a.h--))}}function Lt(a,c,d,g){for(let P=0;P<a.length;++P){const N=a[P];if(!N.da&&N.listener==c&&N.capture==!!d&&N.ha==g)return P}return-1}var Cn="closure_lm_"+(Math.random()*1e6|0),Nu={};function jf(a,c,d,g,P){if(Array.isArray(c)){for(let N=0;N<c.length;N++)jf(a,c[N],d,g,P);return null}return d=$f(d),a&&a[Ot]?a.J(c,d,l(g)?!!g.capture:!1,P):_T(a,c,d,!1,g,P)}function _T(a,c,d,g,P,N){if(!c)throw Error("Invalid event type");const F=l(P)?!!P.capture:!!P;let J=xu(a);if(J||(a[Cn]=J=new It(a)),d=J.add(c,d,g,F,N),d.proxy)return d;if(g=vT(),d.proxy=g,g.src=a,g.listener=d,a.addEventListener)C||(P=F),P===void 0&&(P=!1),a.addEventListener(c.toString(),g,P);else if(a.attachEvent)a.attachEvent(Bf(c.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return d}function vT(){function a(d){return c.call(a.src,a.listener,d)}const c=ET;return a}function zf(a,c,d,g,P){if(Array.isArray(c))for(var N=0;N<c.length;N++)zf(a,c[N],d,g,P);else g=l(g)?!!g.capture:!!g,d=$f(d),a&&a[Ot]?(a=a.i,N=String(c).toString(),N in a.g&&(c=a.g[N],d=Lt(c,d,g,P),d>-1&&(B(c[d]),Array.prototype.splice.call(c,d,1),c.length==0&&(delete a.g[N],a.h--)))):a&&(a=xu(a))&&(c=a.g[c.toString()],a=-1,c&&(a=Lt(c,d,g,P)),(d=a>-1?c[a]:null)&&Du(d))}function Du(a){if(typeof a!="number"&&a&&!a.da){var c=a.src;if(c&&c[Ot])Ar(c.i,a);else{var d=a.type,g=a.proxy;c.removeEventListener?c.removeEventListener(d,g,a.capture):c.detachEvent?c.detachEvent(Bf(d),g):c.addListener&&c.removeListener&&c.removeListener(g),(d=xu(c))?(Ar(d,a),d.h==0&&(d.src=null,c[Cn]=null)):B(a)}}}function Bf(a){return a in Nu?Nu[a]:Nu[a]="on"+a}function ET(a,c){if(a.da)a=!0;else{c=new Ne(c,this);const d=a.listener,g=a.ha||a.src;a.fa&&Du(a),a=d.call(g,c)}return a}function xu(a){return a=a[Cn],a instanceof It?a:null}var Vu="__closure_events_fn_"+(Math.random()*1e9>>>0);function $f(a){return typeof a=="function"?a:(a[Vu]||(a[Vu]=function(c){return a.handleEvent(c)}),a[Vu])}function We(){E.call(this),this.i=new It(this),this.M=this,this.G=null}p(We,E),We.prototype[Ot]=!0,We.prototype.removeEventListener=function(a,c,d,g){zf(this,a,c,d,g)};function tt(a,c){var d,g=a.G;if(g)for(d=[];g;g=g.G)d.push(g);if(a=a.M,g=c.type||c,typeof c=="string")c=new I(c,a);else if(c instanceof I)c.target=c.target||a;else{var P=c;c=new I(g,a),Sr(c,P)}P=!0;let N,F;if(d)for(F=d.length-1;F>=0;F--)N=c.g=d[F],P=Xo(N,g,!0,c)&&P;if(N=c.g=a,P=Xo(N,g,!0,c)&&P,P=Xo(N,g,!1,c)&&P,d)for(F=0;F<d.length;F++)N=c.g=d[F],P=Xo(N,g,!1,c)&&P}We.prototype.N=function(){if(We.Z.N.call(this),this.i){var a=this.i;for(const c in a.g){const d=a.g[c];for(let g=0;g<d.length;g++)B(d[g]);delete a.g[c],a.h--}}this.G=null},We.prototype.J=function(a,c,d,g){return this.i.add(String(a),c,!1,d,g)},We.prototype.K=function(a,c,d,g){return this.i.add(String(a),c,!0,d,g)};function Xo(a,c,d,g){if(c=a.i.g[String(c)],!c)return!0;c=c.concat();let P=!0;for(let N=0;N<c.length;++N){const F=c[N];if(F&&!F.da&&F.capture==d){const J=F.listener,De=F.ha||F.src;F.fa&&Ar(a.i,F),P=J.call(De,g)!==!1&&P}}return P&&!g.defaultPrevented}function wT(a,c){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=h(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:o.setTimeout(a,c||0)}function Hf(a){a.g=wT(()=>{a.g=null,a.i&&(a.i=!1,Hf(a))},a.l);const c=a.h;a.h=null,a.m.apply(null,c)}class TT extends E{constructor(c,d){super(),this.m=c,this.l=d,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:Hf(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function us(a){E.call(this),this.h=a,this.g={}}p(us,E);var qf=[];function Wf(a){K(a.g,function(c,d){this.g.hasOwnProperty(d)&&Du(c)},a),a.g={}}us.prototype.N=function(){us.Z.N.call(this),Wf(this)},us.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ou=o.JSON.stringify,IT=o.JSON.parse,ST=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function Gf(){}function Kf(){}var cs={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Lu(){I.call(this,"d")}p(Lu,I);function Mu(){I.call(this,"c")}p(Mu,I);var Rr={},Qf=null;function Jo(){return Qf=Qf||new We}Rr.Ia="serverreachability";function Yf(a){I.call(this,Rr.Ia,a)}p(Yf,I);function hs(a){const c=Jo();tt(c,new Yf(c))}Rr.STAT_EVENT="statevent";function Xf(a,c){I.call(this,Rr.STAT_EVENT,a),this.stat=c}p(Xf,I);function nt(a){const c=Jo();tt(c,new Xf(c,a))}Rr.Ja="timingevent";function Jf(a,c){I.call(this,Rr.Ja,a),this.size=c}p(Jf,I);function ds(a,c){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},c)}function fs(){this.g=!0}fs.prototype.ua=function(){this.g=!1};function AT(a,c,d,g,P,N){a.info(function(){if(a.g)if(N){var F="",J=N.split("&");for(let ae=0;ae<J.length;ae++){var De=J[ae].split("=");if(De.length>1){const Le=De[0];De=De[1];const Gt=Le.split("_");F=Gt.length>=2&&Gt[1]=="type"?F+(Le+"="+De+"&"):F+(Le+"=redacted&")}}}else F=null;else F=N;return"XMLHTTP REQ ("+g+") [attempt "+P+"]: "+c+`
`+d+`
`+F})}function RT(a,c,d,g,P,N,F){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+P+"]: "+c+`
`+d+`
`+N+" "+F})}function ii(a,c,d,g){a.info(function(){return"XMLHTTP TEXT ("+c+"): "+PT(a,d)+(g?" "+g:"")})}function CT(a,c){a.info(function(){return"TIMEOUT: "+c})}fs.prototype.info=function(){};function PT(a,c){if(!a.g)return c;if(!c)return null;try{const N=JSON.parse(c);if(N){for(a=0;a<N.length;a++)if(Array.isArray(N[a])){var d=N[a];if(!(d.length<2)){var g=d[1];if(Array.isArray(g)&&!(g.length<1)){var P=g[0];if(P!="noop"&&P!="stop"&&P!="close")for(let F=1;F<g.length;F++)g[F]=""}}}}return Ou(N)}catch{return c}}var Zo={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Zf={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},ep;function bu(){}p(bu,Gf),bu.prototype.g=function(){return new XMLHttpRequest},ep=new bu;function ps(a){return encodeURIComponent(String(a))}function kT(a){var c=1;a=a.split(":");const d=[];for(;c>0&&a.length;)d.push(a.shift()),c--;return a.length&&d.push(a.join(":")),d}function Pn(a,c,d,g){this.j=a,this.i=c,this.l=d,this.S=g||1,this.V=new us(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new tp}function tp(){this.i=null,this.g="",this.h=!1}var np={},Fu={};function Uu(a,c,d){a.M=1,a.A=ta(Wt(c)),a.u=d,a.R=!0,rp(a,null)}function rp(a,c){a.F=Date.now(),ea(a),a.B=Wt(a.A);var d=a.B,g=a.S;Array.isArray(g)||(g=[String(g)]),gp(d.i,"t",g),a.C=0,d=a.j.L,a.h=new tp,a.g=Op(a.j,d?c:null,!a.u),a.P>0&&(a.O=new TT(h(a.Y,a,a.g),a.P)),c=a.V,d=a.g,g=a.ba;var P="readystatechange";Array.isArray(P)||(P&&(qf[0]=P.toString()),P=qf);for(let N=0;N<P.length;N++){const F=jf(d,P[N],g||c.handleEvent,!1,c.h||c);if(!F)break;c.g[F.key]=F}c=a.J?pe(a.J):{},a.u?(a.v||(a.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,c)):(a.v="GET",a.g.ea(a.B,a.v,null,c)),hs(),AT(a.i,a.v,a.B,a.l,a.S,a.u)}Pn.prototype.ba=function(a){a=a.target;const c=this.O;c&&Dn(a)==3?c.j():this.Y(a)},Pn.prototype.Y=function(a){try{if(a==this.g)e:{const J=Dn(this.g),De=this.g.ya(),ae=this.g.ca();if(!(J<3)&&(J!=3||this.g&&(this.h.h||this.g.la()||Ip(this.g)))){this.K||J!=4||De==7||(De==8||ae<=0?hs(3):hs(2)),ju(this);var c=this.g.ca();this.X=c;var d=NT(this);if(this.o=c==200,RT(this.i,this.v,this.B,this.l,this.S,J,c),this.o){if(this.U&&!this.L){t:{if(this.g){var g,P=this.g;if((g=P.g?P.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!T(g)){var N=g;break t}}N=null}if(a=N)ii(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,zu(this,a);else{this.o=!1,this.m=3,nt(12),Cr(this),ms(this);break e}}if(this.R){a=!0;let Le;for(;!this.K&&this.C<d.length;)if(Le=DT(this,d),Le==Fu){J==4&&(this.m=4,nt(14),a=!1),ii(this.i,this.l,null,"[Incomplete Response]");break}else if(Le==np){this.m=4,nt(15),ii(this.i,this.l,d,"[Invalid Chunk]"),a=!1;break}else ii(this.i,this.l,Le,null),zu(this,Le);if(ip(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),J!=4||d.length!=0||this.h.h||(this.m=1,nt(16),a=!1),this.o=this.o&&a,!a)ii(this.i,this.l,d,"[Invalid Chunked Response]"),Cr(this),ms(this);else if(d.length>0&&!this.W){this.W=!0;var F=this.j;F.g==this&&F.aa&&!F.P&&(F.j.info("Great, no buffering proxy detected. Bytes received: "+d.length),Qu(F),F.P=!0,nt(11))}}else ii(this.i,this.l,d,null),zu(this,d);J==4&&Cr(this),this.o&&!this.K&&(J==4?Np(this.j,this):(this.o=!1,ea(this)))}else qT(this.g),c==400&&d.indexOf("Unknown SID")>0?(this.m=3,nt(12)):(this.m=0,nt(13)),Cr(this),ms(this)}}}catch{}finally{}};function NT(a){if(!ip(a))return a.g.la();const c=Ip(a.g);if(c==="")return"";let d="";const g=c.length,P=Dn(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return Cr(a),ms(a),"";a.h.i=new o.TextDecoder}for(let N=0;N<g;N++)a.h.h=!0,d+=a.h.i.decode(c[N],{stream:!(P&&N==g-1)});return c.length=0,a.h.g+=d,a.C=0,a.h.g}function ip(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function DT(a,c){var d=a.C,g=c.indexOf(`
`,d);return g==-1?Fu:(d=Number(c.substring(d,g)),isNaN(d)?np:(g+=1,g+d>c.length?Fu:(c=c.slice(g,g+d),a.C=g+d,c)))}Pn.prototype.cancel=function(){this.K=!0,Cr(this)};function ea(a){a.T=Date.now()+a.H,sp(a,a.H)}function sp(a,c){if(a.D!=null)throw Error("WatchDog timer not null");a.D=ds(h(a.aa,a),c)}function ju(a){a.D&&(o.clearTimeout(a.D),a.D=null)}Pn.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(CT(this.i,this.B),this.M!=2&&(hs(),nt(17)),Cr(this),this.m=2,ms(this)):sp(this,this.T-a)};function ms(a){a.j.I==0||a.K||Np(a.j,a)}function Cr(a){ju(a);var c=a.O;c&&typeof c.dispose=="function"&&c.dispose(),a.O=null,Wf(a.V),a.g&&(c=a.g,a.g=null,c.abort(),c.dispose())}function zu(a,c){try{var d=a.j;if(d.I!=0&&(d.g==a||Bu(d.h,a))){if(!a.L&&Bu(d.h,a)&&d.I==3){try{var g=d.Ba.g.parse(c)}catch{g=null}if(Array.isArray(g)&&g.length==3){var P=g;if(P[0]==0){e:if(!d.v){if(d.g)if(d.g.F+3e3<a.F)oa(d),ia(d);else break e;Ku(d),nt(18)}}else d.xa=P[1],0<d.xa-d.K&&P[2]<37500&&d.F&&d.A==0&&!d.C&&(d.C=ds(h(d.Va,d),6e3));lp(d.h)<=1&&d.ta&&(d.ta=void 0)}else kr(d,11)}else if((a.L||d.g==a)&&oa(d),!T(c))for(P=d.Ba.g.parse(c),c=0;c<P.length;c++){let ae=P[c];const Le=ae[0];if(!(Le<=d.K))if(d.K=Le,ae=ae[1],d.I==2)if(ae[0]=="c"){d.M=ae[1],d.ba=ae[2];const Gt=ae[3];Gt!=null&&(d.ka=Gt,d.j.info("VER="+d.ka));const Nr=ae[4];Nr!=null&&(d.za=Nr,d.j.info("SVER="+d.za));const xn=ae[5];xn!=null&&typeof xn=="number"&&xn>0&&(g=1.5*xn,d.O=g,d.j.info("backChannelRequestTimeoutMs_="+g)),g=d;const Vn=a.g;if(Vn){const la=Vn.g?Vn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(la){var N=g.h;N.g||la.indexOf("spdy")==-1&&la.indexOf("quic")==-1&&la.indexOf("h2")==-1||(N.j=N.l,N.g=new Set,N.h&&($u(N,N.h),N.h=null))}if(g.G){const Yu=Vn.g?Vn.g.getResponseHeader("X-HTTP-Session-Id"):null;Yu&&(g.wa=Yu,ce(g.J,g.G,Yu))}}d.I=3,d.l&&d.l.ra(),d.aa&&(d.T=Date.now()-a.F,d.j.info("Handshake RTT: "+d.T+"ms")),g=d;var F=a;if(g.na=Vp(g,g.L?g.ba:null,g.W),F.L){up(g.h,F);var J=F,De=g.O;De&&(J.H=De),J.D&&(ju(J),ea(J)),g.g=F}else Pp(g);d.i.length>0&&sa(d)}else ae[0]!="stop"&&ae[0]!="close"||kr(d,7);else d.I==3&&(ae[0]=="stop"||ae[0]=="close"?ae[0]=="stop"?kr(d,7):Gu(d):ae[0]!="noop"&&d.l&&d.l.qa(ae),d.A=0)}}hs(4)}catch{}}var xT=class{constructor(a,c){this.g=a,this.map=c}};function op(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function ap(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function lp(a){return a.h?1:a.g?a.g.size:0}function Bu(a,c){return a.h?a.h==c:a.g?a.g.has(c):!1}function $u(a,c){a.g?a.g.add(c):a.h=c}function up(a,c){a.h&&a.h==c?a.h=null:a.g&&a.g.has(c)&&a.g.delete(c)}op.prototype.cancel=function(){if(this.i=cp(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function cp(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let c=a.i;for(const d of a.g.values())c=c.concat(d.G);return c}return A(a.i)}var hp=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function VT(a,c){if(a){a=a.split("&");for(let d=0;d<a.length;d++){const g=a[d].indexOf("=");let P,N=null;g>=0?(P=a[d].substring(0,g),N=a[d].substring(g+1)):P=a[d],c(P,N?decodeURIComponent(N.replace(/\+/g," ")):"")}}}function kn(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;a instanceof kn?(this.l=a.l,gs(this,a.j),this.o=a.o,this.g=a.g,ys(this,a.u),this.h=a.h,Hu(this,yp(a.i)),this.m=a.m):a&&(c=String(a).match(hp))?(this.l=!1,gs(this,c[1]||"",!0),this.o=_s(c[2]||""),this.g=_s(c[3]||"",!0),ys(this,c[4]),this.h=_s(c[5]||"",!0),Hu(this,c[6]||"",!0),this.m=_s(c[7]||"")):(this.l=!1,this.i=new Es(null,this.l))}kn.prototype.toString=function(){const a=[];var c=this.j;c&&a.push(vs(c,dp,!0),":");var d=this.g;return(d||c=="file")&&(a.push("//"),(c=this.o)&&a.push(vs(c,dp,!0),"@"),a.push(ps(d).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.u,d!=null&&a.push(":",String(d))),(d=this.h)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(vs(d,d.charAt(0)=="/"?MT:LT,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",vs(d,FT)),a.join("")},kn.prototype.resolve=function(a){const c=Wt(this);let d=!!a.j;d?gs(c,a.j):d=!!a.o,d?c.o=a.o:d=!!a.g,d?c.g=a.g:d=a.u!=null;var g=a.h;if(d)ys(c,a.u);else if(d=!!a.h){if(g.charAt(0)!="/")if(this.g&&!this.h)g="/"+g;else{var P=c.h.lastIndexOf("/");P!=-1&&(g=c.h.slice(0,P+1)+g)}if(P=g,P==".."||P==".")g="";else if(P.indexOf("./")!=-1||P.indexOf("/.")!=-1){g=P.lastIndexOf("/",0)==0,P=P.split("/");const N=[];for(let F=0;F<P.length;){const J=P[F++];J=="."?g&&F==P.length&&N.push(""):J==".."?((N.length>1||N.length==1&&N[0]!="")&&N.pop(),g&&F==P.length&&N.push("")):(N.push(J),g=!0)}g=N.join("/")}else g=P}return d?c.h=g:d=a.i.toString()!=="",d?Hu(c,yp(a.i)):d=!!a.m,d&&(c.m=a.m),c};function Wt(a){return new kn(a)}function gs(a,c,d){a.j=d?_s(c,!0):c,a.j&&(a.j=a.j.replace(/:$/,""))}function ys(a,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);a.u=c}else a.u=null}function Hu(a,c,d){c instanceof Es?(a.i=c,UT(a.i,a.l)):(d||(c=vs(c,bT)),a.i=new Es(c,a.l))}function ce(a,c,d){a.i.set(c,d)}function ta(a){return ce(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function _s(a,c){return a?c?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function vs(a,c,d){return typeof a=="string"?(a=encodeURI(a).replace(c,OT),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function OT(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var dp=/[#\/\?@]/g,LT=/[#\?:]/g,MT=/[#\?]/g,bT=/[#\?@]/g,FT=/#/g;function Es(a,c){this.h=this.g=null,this.i=a||null,this.j=!!c}function Pr(a){a.g||(a.g=new Map,a.h=0,a.i&&VT(a.i,function(c,d){a.add(decodeURIComponent(c.replace(/\+/g," ")),d)}))}t=Es.prototype,t.add=function(a,c){Pr(this),this.i=null,a=si(this,a);let d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(c),this.h+=1,this};function fp(a,c){Pr(a),c=si(a,c),a.g.has(c)&&(a.i=null,a.h-=a.g.get(c).length,a.g.delete(c))}function pp(a,c){return Pr(a),c=si(a,c),a.g.has(c)}t.forEach=function(a,c){Pr(this),this.g.forEach(function(d,g){d.forEach(function(P){a.call(c,P,g,this)},this)},this)};function mp(a,c){Pr(a);let d=[];if(typeof c=="string")pp(a,c)&&(d=d.concat(a.g.get(si(a,c))));else for(a=Array.from(a.g.values()),c=0;c<a.length;c++)d=d.concat(a[c]);return d}t.set=function(a,c){return Pr(this),this.i=null,a=si(this,a),pp(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[c]),this.h+=1,this},t.get=function(a,c){return a?(a=mp(this,a),a.length>0?String(a[0]):c):c};function gp(a,c,d){fp(a,c),d.length>0&&(a.i=null,a.g.set(si(a,c),A(d)),a.h+=d.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],c=Array.from(this.g.keys());for(let g=0;g<c.length;g++){var d=c[g];const P=ps(d);d=mp(this,d);for(let N=0;N<d.length;N++){let F=P;d[N]!==""&&(F+="="+ps(d[N])),a.push(F)}}return this.i=a.join("&")};function yp(a){const c=new Es;return c.i=a.i,a.g&&(c.g=new Map(a.g),c.h=a.h),c}function si(a,c){return c=String(c),a.j&&(c=c.toLowerCase()),c}function UT(a,c){c&&!a.j&&(Pr(a),a.i=null,a.g.forEach(function(d,g){const P=g.toLowerCase();g!=P&&(fp(this,g),gp(this,P,d))},a)),a.j=c}function jT(a,c){const d=new fs;if(o.Image){const g=new Image;g.onload=f(Nn,d,"TestLoadImage: loaded",!0,c,g),g.onerror=f(Nn,d,"TestLoadImage: error",!1,c,g),g.onabort=f(Nn,d,"TestLoadImage: abort",!1,c,g),g.ontimeout=f(Nn,d,"TestLoadImage: timeout",!1,c,g),o.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else c(!1)}function zT(a,c){const d=new fs,g=new AbortController,P=setTimeout(()=>{g.abort(),Nn(d,"TestPingServer: timeout",!1,c)},1e4);fetch(a,{signal:g.signal}).then(N=>{clearTimeout(P),N.ok?Nn(d,"TestPingServer: ok",!0,c):Nn(d,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(P),Nn(d,"TestPingServer: error",!1,c)})}function Nn(a,c,d,g,P){try{P&&(P.onload=null,P.onerror=null,P.onabort=null,P.ontimeout=null),g(d)}catch{}}function BT(){this.g=new ST}function qu(a){this.i=a.Sb||null,this.h=a.ab||!1}p(qu,Gf),qu.prototype.g=function(){return new na(this.i,this.h)};function na(a,c){We.call(this),this.H=a,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(na,We),t=na.prototype,t.open=function(a,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=c,this.readyState=1,Ts(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(c.body=a),(this.H||o).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,ws(this)),this.readyState=0},t.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Ts(this)),this.g&&(this.readyState=3,Ts(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;_p(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function _p(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}t.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var c=a.value?a.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!a.done}))&&(this.response=this.responseText+=c)}a.done?ws(this):Ts(this),this.readyState==3&&_p(this)}},t.Oa=function(a){this.g&&(this.response=this.responseText=a,ws(this))},t.Na=function(a){this.g&&(this.response=a,ws(this))},t.ga=function(){this.g&&ws(this)};function ws(a){a.readyState=4,a.l=null,a.j=null,a.B=null,Ts(a)}t.setRequestHeader=function(a,c){this.A.append(a,c)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],c=this.h.entries();for(var d=c.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=c.next();return a.join(`\r
`)};function Ts(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(na.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function vp(a){let c="";return K(a,function(d,g){c+=g,c+=":",c+=d,c+=`\r
`}),c}function Wu(a,c,d){e:{for(g in d){var g=!1;break e}g=!0}g||(d=vp(d),typeof a=="string"?d!=null&&ps(d):ce(a,c,d))}function Ee(a){We.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(Ee,We);var $T=/^https?$/i,HT=["POST","PUT"];t=Ee.prototype,t.Fa=function(a){this.H=a},t.ea=function(a,c,d,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);c=c?c.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():ep.g(),this.g.onreadystatechange=_(h(this.Ca,this));try{this.B=!0,this.g.open(c,String(a),!0),this.B=!1}catch(N){Ep(this,N);return}if(a=d||"",d=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var P in g)d.set(P,g[P]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const N of g.keys())d.set(N,g.get(N));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(d.keys()).find(N=>N.toLowerCase()=="content-type"),P=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(HT,c,void 0)>=0)||g||P||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[N,F]of d)this.g.setRequestHeader(N,F);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(N){Ep(this,N)}};function Ep(a,c){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=c,a.o=5,wp(a),ra(a)}function wp(a){a.A||(a.A=!0,tt(a,"complete"),tt(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,tt(this,"complete"),tt(this,"abort"),ra(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ra(this,!0)),Ee.Z.N.call(this)},t.Ca=function(){this.u||(this.B||this.v||this.j?Tp(this):this.Xa())},t.Xa=function(){Tp(this)};function Tp(a){if(a.h&&typeof s<"u"){if(a.v&&Dn(a)==4)setTimeout(a.Ca.bind(a),0);else if(tt(a,"readystatechange"),Dn(a)==4){a.h=!1;try{const N=a.ca();e:switch(N){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var d;if(!(d=c)){var g;if(g=N===0){let F=String(a.D).match(hp)[1]||null;!F&&o.self&&o.self.location&&(F=o.self.location.protocol.slice(0,-1)),g=!$T.test(F?F.toLowerCase():"")}d=g}if(d)tt(a,"complete"),tt(a,"success");else{a.o=6;try{var P=Dn(a)>2?a.g.statusText:""}catch{P=""}a.l=P+" ["+a.ca()+"]",wp(a)}}finally{ra(a)}}}}function ra(a,c){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const d=a.g;a.g=null,c||tt(a,"ready");try{d.onreadystatechange=null}catch{}}}t.isActive=function(){return!!this.g};function Dn(a){return a.g?a.g.readyState:0}t.ca=function(){try{return Dn(this)>2?this.g.status:-1}catch{return-1}},t.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.La=function(a){if(this.g){var c=this.g.responseText;return a&&c.indexOf(a)==0&&(c=c.substring(a.length)),IT(c)}};function Ip(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function qT(a){const c={};a=(a.g&&Dn(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(T(a[g]))continue;var d=kT(a[g]);const P=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const N=c[P]||[];c[P]=N,N.push(d)}X(c,function(g){return g.join(", ")})}t.ya=function(){return this.o},t.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Is(a,c,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||c}function Sp(a){this.za=0,this.i=[],this.j=new fs,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Is("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Is("baseRetryDelayMs",5e3,a),this.Za=Is("retryDelaySeedMs",1e4,a),this.Ta=Is("forwardChannelMaxRetries",2,a),this.va=Is("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new op(a&&a.concurrentRequestLimit),this.Ba=new BT,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}t=Sp.prototype,t.ka=8,t.I=1,t.connect=function(a,c,d,g){nt(0),this.W=a,this.H=c||{},d&&g!==void 0&&(this.H.OSID=d,this.H.OAID=g),this.F=this.X,this.J=Vp(this,null,this.W),sa(this)};function Gu(a){if(Ap(a),a.I==3){var c=a.V++,d=Wt(a.J);if(ce(d,"SID",a.M),ce(d,"RID",c),ce(d,"TYPE","terminate"),Ss(a,d),c=new Pn(a,a.j,c),c.M=2,c.A=ta(Wt(d)),d=!1,o.navigator&&o.navigator.sendBeacon)try{d=o.navigator.sendBeacon(c.A.toString(),"")}catch{}!d&&o.Image&&(new Image().src=c.A,d=!0),d||(c.g=Op(c.j,null),c.g.ea(c.A)),c.F=Date.now(),ea(c)}xp(a)}function ia(a){a.g&&(Qu(a),a.g.cancel(),a.g=null)}function Ap(a){ia(a),a.v&&(o.clearTimeout(a.v),a.v=null),oa(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function sa(a){if(!ap(a.h)&&!a.m){a.m=!0;var c=a.Ea;U||m(),j||(U(),j=!0),y.add(c,a),a.D=0}}function WT(a,c){return lp(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=c.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=ds(h(a.Ea,a,c),Dp(a,a.D)),a.D++,!0)}t.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const P=new Pn(this,this.j,a);let N=this.o;if(this.U&&(N?(N=pe(N),Sr(N,this.U)):N=this.U),this.u!==null||this.R||(P.J=N,N=null),this.S)e:{for(var c=0,d=0;d<this.i.length;d++){t:{var g=this.i[d];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(c+=g,c>4096){c=d;break e}if(c===4096||d===this.i.length-1){c=d+1;break e}}c=1e3}else c=1e3;c=Cp(this,P,c),d=Wt(this.J),ce(d,"RID",a),ce(d,"CVER",22),this.G&&ce(d,"X-HTTP-Session-Id",this.G),Ss(this,d),N&&(this.R?c="headers="+ps(vp(N))+"&"+c:this.u&&Wu(d,this.u,N)),$u(this.h,P),this.Ra&&ce(d,"TYPE","init"),this.S?(ce(d,"$req",c),ce(d,"SID","null"),P.U=!0,Uu(P,d,null)):Uu(P,d,c),this.I=2}}else this.I==3&&(a?Rp(this,a):this.i.length==0||ap(this.h)||Rp(this))};function Rp(a,c){var d;c?d=c.l:d=a.V++;const g=Wt(a.J);ce(g,"SID",a.M),ce(g,"RID",d),ce(g,"AID",a.K),Ss(a,g),a.u&&a.o&&Wu(g,a.u,a.o),d=new Pn(a,a.j,d,a.D+1),a.u===null&&(d.J=a.o),c&&(a.i=c.G.concat(a.i)),c=Cp(a,d,1e3),d.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),$u(a.h,d),Uu(d,g,c)}function Ss(a,c){a.H&&K(a.H,function(d,g){ce(c,g,d)}),a.l&&K({},function(d,g){ce(c,g,d)})}function Cp(a,c,d){d=Math.min(a.i.length,d);const g=a.l?h(a.l.Ka,a.l,a):null;e:{var P=a.i;let J=-1;for(;;){const De=["count="+d];J==-1?d>0?(J=P[0].g,De.push("ofs="+J)):J=0:De.push("ofs="+J);let ae=!0;for(let Le=0;Le<d;Le++){var N=P[Le].g;const Gt=P[Le].map;if(N-=J,N<0)J=Math.max(0,P[Le].g-100),ae=!1;else try{N="req"+N+"_"||"";try{var F=Gt instanceof Map?Gt:Object.entries(Gt);for(const[Nr,xn]of F){let Vn=xn;l(xn)&&(Vn=Ou(xn)),De.push(N+Nr+"="+encodeURIComponent(Vn))}}catch(Nr){throw De.push(N+"type="+encodeURIComponent("_badmap")),Nr}}catch{g&&g(Gt)}}if(ae){F=De.join("&");break e}}F=void 0}return a=a.i.splice(0,d),c.G=a,F}function Pp(a){if(!a.g&&!a.v){a.Y=1;var c=a.Da;U||m(),j||(U(),j=!0),y.add(c,a),a.A=0}}function Ku(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=ds(h(a.Da,a),Dp(a,a.A)),a.A++,!0)}t.Da=function(){if(this.v=null,kp(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=ds(h(this.Wa,this),a)}},t.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,nt(10),ia(this),kp(this))};function Qu(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function kp(a){a.g=new Pn(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var c=Wt(a.na);ce(c,"RID","rpc"),ce(c,"SID",a.M),ce(c,"AID",a.K),ce(c,"CI",a.F?"0":"1"),!a.F&&a.ia&&ce(c,"TO",a.ia),ce(c,"TYPE","xmlhttp"),Ss(a,c),a.u&&a.o&&Wu(c,a.u,a.o),a.O&&(a.g.H=a.O);var d=a.g;a=a.ba,d.M=1,d.A=ta(Wt(c)),d.u=null,d.R=!0,rp(d,a)}t.Va=function(){this.C!=null&&(this.C=null,ia(this),Ku(this),nt(19))};function oa(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function Np(a,c){var d=null;if(a.g==c){oa(a),Qu(a),a.g=null;var g=2}else if(Bu(a.h,c))d=c.G,up(a.h,c),g=1;else return;if(a.I!=0){if(c.o)if(g==1){d=c.u?c.u.length:0,c=Date.now()-c.F;var P=a.D;g=Jo(),tt(g,new Jf(g,d)),sa(a)}else Pp(a);else if(P=c.m,P==3||P==0&&c.X>0||!(g==1&&WT(a,c)||g==2&&Ku(a)))switch(d&&d.length>0&&(c=a.h,c.i=c.i.concat(d)),P){case 1:kr(a,5);break;case 4:kr(a,10);break;case 3:kr(a,6);break;default:kr(a,2)}}}function Dp(a,c){let d=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(d*=2),d*c}function kr(a,c){if(a.j.info("Error code "+c),c==2){var d=h(a.bb,a),g=a.Ua;const P=!g;g=new kn(g||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||gs(g,"https"),ta(g),P?jT(g.toString(),d):zT(g.toString(),d)}else nt(2);a.I=0,a.l&&a.l.pa(c),xp(a),Ap(a)}t.bb=function(a){a?(this.j.info("Successfully pinged google.com"),nt(2)):(this.j.info("Failed to ping google.com"),nt(1))};function xp(a){if(a.I=0,a.ja=[],a.l){const c=cp(a.h);(c.length!=0||a.i.length!=0)&&(k(a.ja,c),k(a.ja,a.i),a.h.i.length=0,A(a.i),a.i.length=0),a.l.oa()}}function Vp(a,c,d){var g=d instanceof kn?Wt(d):new kn(d);if(g.g!="")c&&(g.g=c+"."+g.g),ys(g,g.u);else{var P=o.location;g=P.protocol,c=c?c+"."+P.hostname:P.hostname,P=+P.port;const N=new kn(null);g&&gs(N,g),c&&(N.g=c),P&&ys(N,P),d&&(N.h=d),g=N}return d=a.G,c=a.wa,d&&c&&ce(g,d,c),ce(g,"VER",a.ka),Ss(a,g),g}function Op(a,c,d){if(c&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=a.Aa&&!a.ma?new Ee(new qu({ab:d})):new Ee(a.ma),c.Fa(a.L),c}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Lp(){}t=Lp.prototype,t.ra=function(){},t.qa=function(){},t.pa=function(){},t.oa=function(){},t.isActive=function(){return!0},t.Ka=function(){};function aa(){}aa.prototype.g=function(a,c){return new mt(a,c)};function mt(a,c){We.call(this),this.g=new Sp(c),this.l=a,this.h=c&&c.messageUrlParams||null,a=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(a?a["X-WebChannel-Content-Type"]=c.messageContentType:a={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(a?a["X-WebChannel-Client-Profile"]=c.sa:a={"X-WebChannel-Client-Profile":c.sa}),this.g.U=a,(a=c&&c.Qb)&&!T(a)&&(this.g.u=a),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!T(c)&&(this.g.G=c,a=this.h,a!==null&&c in a&&(a=this.h,c in a&&delete a[c])),this.j=new oi(this)}p(mt,We),mt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},mt.prototype.close=function(){Gu(this.g)},mt.prototype.o=function(a){var c=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.v&&(d={},d.__data__=Ou(a),a=d);c.i.push(new xT(c.Ya++,a)),c.I==3&&sa(c)},mt.prototype.N=function(){this.g.l=null,delete this.j,Gu(this.g),delete this.g,mt.Z.N.call(this)};function Mp(a){Lu.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var c=a.__sm__;if(c){e:{for(const d in c){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,c=c!==null&&a in c?c[a]:void 0),this.data=c}else this.data=a}p(Mp,Lu);function bp(){Mu.call(this),this.status=1}p(bp,Mu);function oi(a){this.g=a}p(oi,Lp),oi.prototype.ra=function(){tt(this.g,"a")},oi.prototype.qa=function(a){tt(this.g,new Mp(a))},oi.prototype.pa=function(a){tt(this.g,new bp)},oi.prototype.oa=function(){tt(this.g,"b")},aa.prototype.createWebChannel=aa.prototype.g,mt.prototype.send=mt.prototype.o,mt.prototype.open=mt.prototype.m,mt.prototype.close=mt.prototype.close,BE=function(){return new aa},zE=function(){return Jo()},jE=Rr,Mh={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Zo.NO_ERROR=0,Zo.TIMEOUT=8,Zo.HTTP_ERROR=6,Qa=Zo,Zf.COMPLETE="complete",UE=Zf,Kf.EventType=cs,cs.OPEN="a",cs.CLOSE="b",cs.ERROR="c",cs.MESSAGE="d",We.prototype.listen=We.prototype.J,js=Kf,Ee.prototype.listenOnce=Ee.prototype.K,Ee.prototype.getLastError=Ee.prototype.Ha,Ee.prototype.getLastErrorCode=Ee.prototype.ya,Ee.prototype.getStatus=Ee.prototype.ca,Ee.prototype.getResponseJson=Ee.prototype.La,Ee.prototype.getResponseText=Ee.prototype.la,Ee.prototype.send=Ee.prototype.ea,Ee.prototype.setWithCredentials=Ee.prototype.Fa,FE=Ee}).apply(typeof Ca<"u"?Ca:typeof self<"u"?self:typeof window<"u"?window:{});const Sg="@firebase/firestore",Ag="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yr=new Qd("@firebase/firestore");function li(){return Yr.logLevel}function $(t,...e){if(Yr.logLevel<=ee.DEBUG){const n=e.map(af);Yr.debug(`Firestore (${ns}): ${t}`,...n)}}function In(t,...e){if(Yr.logLevel<=ee.ERROR){const n=e.map(af);Yr.error(`Firestore (${ns}): ${t}`,...n)}}function Hi(t,...e){if(Yr.logLevel<=ee.WARN){const n=e.map(af);Yr.warn(`Firestore (${ns}): ${t}`,...n)}}function af(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G(t,e,n){let r="Unexpected state";typeof e=="string"?r=e:n=e,$E(t,r,n)}function $E(t,e,n){let r=`FIRESTORE (${ns}) INTERNAL ASSERTION FAILED: ${e} (ID: ${t.toString(16)})`;if(n!==void 0)try{r+=" CONTEXT: "+JSON.stringify(n)}catch{r+=" CONTEXT: "+n}throw In(r),new Error(r)}function se(t,e,n,r){let i="Unexpected state";typeof n=="string"?i=n:r=n,t||$E(e,i,r)}function Y(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ke(t,e){const n={typeString:t};return e&&(n.value=e),n}function qo(t,e){if(!WE(t))throw new z(V.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in e)if(e[r]){const i=e[r].typeString,s="value"in e[r]?{value:e[r].value}:void 0;if(!(r in t)){n=`JSON missing required field: '${r}'`;break}const o=t[r];if(i&&typeof o!==i){n=`JSON field '${r}' must be a ${i}.`;break}if(s!==void 0&&o!==s.value){n=`Expected '${r}' field to equal '${s.value}'`;break}}if(n)throw new z(V.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Co=-1;function DC(t,e){const n=t.toTimestamp().seconds,r=t.toTimestamp().nanoseconds+1,i=Q.fromTimestamp(r===1e9?new de(n+1,0):new de(n,r));return new cr(i,q.empty(),e)}function xC(t){return new cr(t.readTime,t.key,Co)}class cr{constructor(e,n,r){this.readTime=e,this.documentKey=n,this.largestBatchId=r}static min(){return new cr(Q.min(),q.empty(),Co)}static max(){return new cr(Q.max(),q.empty(),Co)}}function VC(t,e){let n=t.readTime.compareTo(e.readTime);return n!==0?n:(n=q.comparator(t.documentKey,e.documentKey),n!==0?n:te(t.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YE="server_timestamp",XE="__type__",JE="__previous_value__",ZE="__local_write_time__";function cf(t){var n,r;return((r=(((n=t==null?void 0:t.mapValue)==null?void 0:n.fields)||{})[XE])==null?void 0:r.stringValue)===YE}function fu(t){const e=t.mapValue.fields[JE];return cf(e)?fu(e):e}function Po(t){const e=hr(t.mapValue.fields[ZE].timestampValue);return new de(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zC{constructor(e,n,r,i,s,o,l,u,h,f){this.databaseId=e,this.appId=n,this.persistenceKey=r,this.host=i,this.ssl=s,this.forceLongPolling=o,this.autoDetectLongPolling=l,this.longPollingOptions=u,this.useFetchStreams=h,this.isUsingEmulator=f}}const Ol="(default)";class ko{constructor(e,n){this.projectId=e,this.database=n||Ol}static empty(){return new ko("","")}get isDefaultDatabase(){return this.database===Ol}isEqual(e){return e instanceof ko&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e){this.value=e}static empty(){return new ct({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let r=0;r<e.length-1;++r)if(n=(n.mapValue.fields||{})[e.get(r)],!Xa(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=no(n)}setAll(e){let n=Be.emptyPath(),r={},i=[];e.forEach((o,l)=>{if(!n.isImmediateParentOf(l)){const u=this.getFieldsMap(n);this.applyChanges(u,r,i),r={},i=[],n=l.popLast()}o?r[l.lastSegment()]=no(o):i.push(l.lastSegment())});const s=this.getFieldsMap(n);this.applyChanges(s,r,i)}delete(e){const n=this.field(e.popLast());Xa(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return an(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let r=0;r<e.length;++r){let i=n.mapValue.fields[e.get(r)];Xa(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},n.mapValue.fields[e.get(r)]=i),n=i}return n.mapValue.fields}applyChanges(e,n,r){Tr(n,(i,s)=>e[i]=s);for(const i of r)delete e[i]}clone(){return new ct(no(this.value))}}function nw(t){const e=[];return Tr(t.fields,(n,r)=>{const i=new Be([n]);if(Xa(r)){const s=nw(r.mapValue).fields;if(s.length===0)e.push(i);else for(const o of s)e.push(i.child(o))}else e.push(i)}),new _t(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{constructor(e,n="asc"){this.field=e,this.dir=n}}function qC(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sP=new ve(q.comparator);function Sn(){return sP}const dw=new ve(q.comparator);function zs(...t){let e=dw;for(const n of t)e=e.insert(n.key,n);return e}function fw(t){let e=dw;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function br(){return io()}function pw(){return io()}function io(){return new ti(t=>t.toString(),(t,e)=>t.isEqual(e))}const oP=new ve(q.comparator),aP=new Oe(q.comparator);function ne(...t){let e=aP;for(const n of t)e=e.add(n);return e}const lP=new Oe(te);function uP(){return lP}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,Go.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new vu(Q.min(),i,new ve(te),Sn(),ne())}}class Go{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new Go(r,n,ne(),ne(),ne())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Total Duration: ${h-f}ms`),O.resolve({didRun:!0,sequenceNumbersCollected:i,targetsRemoved:s,documentsRemoved:p})))}}function YP(t,e){return new QP(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ZP{constructor(e,n,r,i){this.remoteDocumentCache=e,this.mutationQueue=n,this.documentOverlayCache=r,this.indexManager=i}getDocument(e,n){let r=null;return this.documentOverlayCache.getOverlay(e,n).next(i=>(r=i,this.remoteDocumentCache.getEntry(e,n))).next(i=>(r!==null&&so(r.mutation,i,_t.empty(),de.now()),i))}getDocuments(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.getLocalViewOfDocuments(e,r,ne()).next(()=>r))}getLocalViewOfDocuments(e,n,r=ne()){const i=br();return this.populateOverlays(e,i,n).next(()=>this.computeViews(e,n,i,r).next(s=>{let o=zs();return s.forEach((l,u)=>{o=o.insert(l,u.overlayedDocument)}),o}))}getOverlayedDocuments(e,n){const r=br();return this.populateOverlays(e,r,n).next(()=>this.computeViews(e,n,r,ne()))}populateOverlays(e,n,r){const i=[];return r.forEach(s=>{n.has(s)||i.push(s)}),this.documentOverlayCache.getOverlays(e,i).next(s=>{s.forEach((o,l)=>{n.set(o,l)})})}computeViews(e,n,r,i){let s=Sn();const o=io(),l=function(){return io()}();return n.forEach((u,h)=>{const f=r.get(h.key);i.has(h.key)&&(f===void 0||f.mutation instanceof Ir)?s=s.insert(h.key,h):f!==void 0?(o.set(h.key,f.mutation.getFieldMask()),so(f.mutation,h,f.mutation.getFieldMask(),de.now())):o.set(h.key,_t.empty())}),this.recalculateAndSaveOverlays(e,s).next(u=>(u.forEach((h,f)=>o.set(h,f)),n.forEach((h,f)=>l.set(h,new JP(f,o.get(h)??null))),l))}recalculateAndSaveOverlays(e,n){const r=io();let i=new ve((o,l)=>o-l),s=ne();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,n).next(o=>{for(const l of o)l.keys().forEach(u=>{const h=n.get(u);if(h===null)return;let f=r.get(u)||_t.empty();f=l.applyToLocalView(h,f),r.set(u,f);const p=(i.get(l.batchId)||ne()).add(u);i=i.insert(l.batchId,p)})}).next(()=>{const o=[],l=i.getReverseIterator();for(;l.hasNext();){const u=l.getNext(),h=u.key,f=u.value,p=pw();f.forEach(_=>{if(!s.has(_)){const A=Ew(n.get(_),r.get(_));A!==null&&p.set(_,A),s=s.add(_)}}),o.push(this.documentOverlayCache.saveOverlays(e,h,p))}return O.waitFor(o)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,n,r,i){return function(o){return q.isDocumentKey(o.path)&&o.collectionGroup===null&&o.filters.length===0}(n)?this.getDocumentsMatchingDocumentQuery(e,n.path):uw(n)?this.getDocumentsMatchingCollectionGroupQuery(e,n,r,i):this.getDocumentsMatchingCollectionQuery(e,n,r,i)}getNextDocuments(e,n,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,n,r,i).next(s=>{const o=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,n,r.largestBatchId,i-s.size):O.resolve(br());let l=Co,u=s;return o.next(h=>O.forEach(h,(f,p)=>(l<p.largestBatchId&&(l=p.largestBatchId),s.get(f)?O.resolve():this.remoteDocumentCache.getEntry(e,f).next(_=>{u=u.insert(f,_)}))).next(()=>this.populateOverlays(e,h,s)).next(()=>this.computeViews(e,u,h,ne())).next(f=>({batchId:l,changes:fw(f)})))})}getDocumentsMatchingDocumentQuery(e,n){return this.getDocument(e,new q(n)).next(r=>{let i=zs();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(e,n,r,i){const s=n.collectionGroup;let o=zs();return this.indexManager.getCollectionParents(e,s).next(l=>O.forEach(l,u=>{const h=function(p,_){return new ss(_,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)}(n,u.child(s));return this.getDocumentsMatchingCollectionQuery(e,h,r,i).next(f=>{f.forEach((p,_)=>{o=o.insert(p,_)})})}).next(()=>o))}getDocumentsMatchingCollectionQuery(e,n,r,i){let s;return this.documentOverlayCache.getOverlaysForCollection(e,n.path,r.largestBatchId).next(o=>(s=o,this.remoteDocumentCache.getDocumentsMatchingQuery(e,n,r,s,i))).next(o=>{s.forEach((u,h)=>{const f=h.getKey();o.get(f)===null&&(o=o.insert(f,Je.newInvalidDocument(f)))});let l=zs();return o.forEach((u,h)=>{const f=s.get(u);f!==void 0&&so(f.mutation,h,_t.empty(),de.now()),gu(n,h)&&(l=l.insert(u,h))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe="WebChannelConnection";class Sk extends Tk{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,r,i,s){const o=Qh();return new Promise((l,u)=>{const h=new FE;h.setWithCredentials(!0),h.listenOnce(UE.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Qa.NO_ERROR:const p=h.getResponseJson();$(Qe,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case Qa.TIMEOUT:$(Qe,`RPC '${e}' ${o} timed out`),u(new z(V.DEADLINE_EXCEEDED,"Request time out"));break;case Qa.HTTP_ERROR:const _=h.getStatus();if($(Qe,`RPC '${e}' ${o} failed with status:`,_,"response text:",h.getResponseText()),_>0){let A=h.getResponseJson();Array.isArray(A)&&(A=A[0]);const k=A==null?void 0:A.error;if(k&&k.status&&k.message){const D=function(S){const w=S.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(w)>=0?w:V.UNKNOWN}(k.status);u(new z(D,k.message))}else u(new z(V.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new z(V.UNAVAILABLE,"Connection failed."));break;default:G(9055,{l_:e,streamId:o,h_:h.getLastErrorCode(),P_:h.getLastError()})}}finally{$(Qe,`RPC '${e}' ${o} completed.`)}});const f=JSON.stringify(i);$(Qe,`RPC '${e}' ${o} sending request:`,i),h.send(n,"POST",f,r,15)})}T_(e,n,r){const i=Qh(),s=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=BE(),l=zE(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const f=s.join("");$(Qe,`Creating RPC '${e}' stream ${i}: ${f}`,u);const p=o.createWebChannel(f,u);this.I_(p);let _=!1,A=!1;const k=new Ik({Yo:L=>{A?$(Qe,`Not sending because RPC '${e}' stream ${i} is closed:`,L):(_||($(Qe,`Opening RPC '${e}' stream ${i} transport.`),p.open(),_=!0),$(Qe,`RPC '${e}' stream ${i} sending:`,L),p.send(L))},Zo:()=>p.close()}),D=(L,S,w)=>{L.listen(S,R=>{try{w(R)}catch(x){setTimeout(()=>{throw x},0)}})};return D(p,js.EventType.OPEN,()=>{A||($(Qe,`RPC '${e}' stream ${i} transport opened.`),k.o_())}),D(p,js.EventType.CLOSE,()=>{A||(A=!0,$(Qe,`RPC '${e}' stream ${i} transport closed`),k.a_(),this.E_(p))}),D(p,js.EventType.ERROR,L=>{A||(A=!0,Hi(Qe,`RPC '${e}' stream ${i} transport errored. Name:`,L.name,"Message:",L.message),k.a_(new z(V.UNAVAILABLE,"The operation could not be completed")))}),D(p,js.EventType.MESSAGE,L=>{var S;if(!A){const w=L.data[0];se(!!w,16349);const R=w,x=(R==null?void 0:R.error)||((S=R[0])==null?void 0:S.error);if(x){$(Qe,`RPC '${e}' stream ${i} received error:`,x);const U=x.status;let j=function(v){const E=Re[v];if(E!==void 0)return Tw(E)}(U),y=x.message;j===void 0&&(j=V.INTERNAL,y="Unknown error status: "+U+" with message "+x.message),A=!0,k.a_(new z(j,y)),p.close()}else $(Qe,`RPC '${e}' stream ${i} received:`,w),k.u_(w)}}),D(l,jE.STAT_EVENT,L=>{L.stat===Mh.PROXY?$(Qe,`RPC '${e}' stream ${i} detected buffering proxy`):L.stat===Mh.NOPROXY&&$(Qe,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{k.__()},0),k}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(n=>n===e)}}function Vc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cf{constructor(e,n,r,i,s){this.asyncQueue=e,this.timerId=n,this.targetTimeMs=r,this.op=i,this.removalCallback=s,this.deferred=new or,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(o=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,n,r,i,s){const o=Date.now()+r,l=new Cf(e,n,o,i,s);return l.start(r),l}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new z(V.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Pf(t,e){if(In("AsyncQueue",`${e}: ${t}`),is(t))return new z(V.UNAVAILABLE,`${e}: ${t}`);throw t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oi{static emptySet(e){return new Oi(e.comparator)}constructor(e){this.comparator=e?(n,r)=>e(n,r)||q.comparator(n.key,r.key):(n,r)=>q.comparator(n.key,r.key),this.keyedMap=zs(),this.sortedSet=new ve(this.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,r)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof Oi)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),r=e.sortedSet.getIterator();for(;n.hasNext();){const i=n.getNext().key,s=r.getNext().key;if(!i.isEqual(s))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tT{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):In("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,n){setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new z(V.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new z(V.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return te(this._lat,e._lat)||te(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:sn._jsonSchemaVersion}}static fromJSON(e){if(qo(e,sn._jsonSchema))return new sn(e.latitude,e.longitude)}}sn._jsonSchemaVersion="firestore/geoPoint/1.0",sn._jsonSchema={type:ke("string",sn._jsonSchemaVersion),latitude:ke("number"),longitude:ke("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e){this._values=(e||[]).map(n=>n)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,i){if(r.length!==i.length)return!1;for(let s=0;s<r.length;++s)if(r[s]!==i[s])return!1;return!0}(this._values,e._values)}toJSON(){return{type:on._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(qo(e,on._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(n=>typeof n=="number"))return new on(e.vectorValues);throw new z(V.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}on._jsonSchemaVersion="firestore/vectorValue/1.0",on._jsonSchema={type:ke("string",on._jsonSchemaVersion),vectorValues:ke("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ay(t){t=Nt(t,Te);const e=Nt(t.firestore,gr);return fN(xf(e),t._key).then(n=>gT(e,t,n))}Li._jsonSchemaVersion="firestore/querySnapshot/1.0",Li._jsonSchema={type:ke("string",Li._jsonSchemaVersion),bundleSource:ke("string","QuerySnapshot"),bundleName:ke("string"),bundle:ke("string")};class mT extends CN{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ct(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Te(this.firestore,null,n)}}function Ry(t,e,n){t=Nt(t,Te);const r=Nt(t.firestore,gr),i=pT(t.converter,e);return ku(r,[aT(Au(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,Dt.none())])}function kN(t,e,n,...r){t=Nt(t,Te);const i=Nt(t.firestore,gr),s=Au(i);let o;return o=typeof(e=Ue(e))=="string"||e instanceof Su?wN(s,"updateDoc",t._key,e,n,r):EN(s,"updateDoc",t._key,e),ku(i,[o.toMutation(t._key,Dt.exists(!0))])}function NN(t){return ku(Nt(t.firestore,gr),[new mf(t._key,Dt.none())])}function DN(t,e){const n=Nt(t.firestore,gr),r=$s(t),i=pT(t.converter,e);return ku(n,[aT(Au(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,Dt.exists(!1))]).then(()=>r)}function Cy(t,...e){var u,h,f;t=Ue(t);let n={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Ey(e[r])||(n=e[r++]);const i={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(Ey(e[r])){const p=e[r];e[r]=(u=p.next)==null?void 0:u.bind(p),e[r+1]=(h=p.error)==null?void 0:h.bind(p),e[r+2]=(f=p.complete)==null?void 0:f.bind(p)}let s,o,l;if(t instanceof Te)o=Nt(t.firestore,gr),l=pu(t._key.path),s={next:p=>{e[r]&&e[r](gT(o,t,p))},error:e[r+1],complete:e[r+2]};else{const p=Nt(t,ri);o=Nt(p.firestore,gr),l=p._query;const _=new mT(o);s={next:A=>{e[r]&&e[r](new Li(o,_,p,A))},error:e[r+1],complete:e[r+2]},AN(t._query)}return function(_,A,k,D){const L=new tT(D),S=new Ww(A,L,k);return _.asyncQueue.enqueueAndForget(async()=>Hw(await Zh(_),S)),()=>{L.Nu(),_.asyncQueue.enqueueAndForget(async()=>qw(await Zh(_),S))}}(xf(o),l,i,s)}function ku(t,e){return function(r,i){const s=new or;return r.asyncQueue.enqueueAndForget(async()=>tN(await dN(r),i,s)),s.promise}(xf(t),e)}function gT(t,e,n){const r=n.docs.get(e._key),i=new mT(t);return new jr(t,i,e._key,r,new Hs(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){ns=i})(es),$i(new Gr("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new gr(new TC(r.getProvider("auth-internal")),new AC(o,r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new z(V.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ko(h.options.projectId,f)}(o,i),o);return s={useFetchStreams:n,...s},l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),ir(Sg,Ag,e),ir(Sg,Ag,"esm2020")})();const xN={apiKey:"AIzaSyDpCXfYo1X3pPWZp8VBbScZCcy9a9nQ5tU",authDomain:"tii-project-tracker.firebaseapp.com",projectId:"tii-project-tracker",storageBucket:"tii-project-tracker.firebasestorage.app",messagingSenderId:"831301632726",appId:"1:831301632726:web:7859defc3f56bda1fbff77",measurementId:"G-NCWTDRSFNV"},yT=Zv(xN),xa=_C(yT),ln=mN(yT),Py="/TII_ProjectManagement/assets/tii-logo-BKapnJXZ.png";function ky(){return Math.random().toString(36).slice(2,9)}function Mn(){return new Date().toISOString()}function VN(t){if(!t)return null;const r=new Date(t)-new Date;return Math.ceil(r/(1e3*60*60*24))}function ON({content:t}){const e=n=>n.preventDefault();return M.jsxs("div",{className:"p-3 bg-yellow-50 border border-yellow-200 rounded text-sm select-none",onCopy:e,onCut:n=>n.preventDefault(),onPaste:n=>n.preventDefault(),onContextMenu:n=>n.preventDefault(),style:{userSelect:"none",WebkitUserSelect:"none",MozUserSelect:"none"},children:[M.jsx("div",{className:"font-semibold text-yellow-700 mb-1",children:"🔒 Protected Resources (view only)"}),M.jsx("div",{style:{whiteSpace:"pre-wrap"},children:(t||"").split(/\n/).map((n,r)=>{const i=/(https?:\/\/[^\s]+)/g;if(i.test(n)){const s=n.split(i).filter(Boolean);return M.jsx("div",{children:s.map((o,l)=>i.test(o)?M.jsx("a",{href:o,target:"_blank",rel:"noreferrer",className:"underline text-blue-600",children:o},l):M.jsx("span",{children:o},l))},r)}return M.jsx("div",{children:n},r)})})]})}function LN(){const[t,e]=at.useState(null),[n,r]=at.useState(null),[i,s]=at.useState([]),[o,l]=at.useState([]),[u,h]=at.useState(!0),[f,p]=at.useState({email:"",password:""}),[_,A]=at.useState(!1),[k,D]=at.useState({name:"",description:"",assignedTo:"",deadline:"",resources:""});at.useEffect(()=>{const y=xa.onAuthStateChanged(async v=>{if(e(v),v){const E=$s(ln,"users",v.uid),I=await Ay(E);if(I.exists())r(I.data());else{const C={uid:v.uid,email:v.email,role:"member",name:v.email.split("@")[0],createdAt:Mn()};await Ry(E,C),r(C)}}else r(null),l([])});at.useEffect(()=>{async function v(){try{const I=(await getDocs(Vs(ln,"users"))).docs.map(C=>({id:C.id,...C.data()}));console.log("Users loaded:",I),s(I)}catch(E){console.error("Failed to fetch users:",E)}}v()},[]);const m=Cy(Vs(ln,"users"),v=>{const E=[];v.forEach(I=>E.push({id:I.id,...I.data()})),s(E)});return()=>{y(),m()}},[]),at.useEffect(()=>{if(!n)return;h(!0);let y;n.role==="admin"?y=wy(Vs(ln,"projects"),Ty("deadline")):y=wy(Vs(ln,"projects"),RN("assignedTo","==",n.uid),Ty("deadline"));const m=Cy(y,v=>{const E=[];v.forEach(I=>E.push({id:I.id,...I.data()})),l(E),h(!1)},v=>{console.error("projects snapshot error",v),h(!1)});return()=>m()},[n]);async function L(y){y==null||y.preventDefault();try{await iR(xa,f.email,f.password),p({email:"",password:""})}catch(m){alert("Login failed: "+m.message)}}async function S(y){y==null||y.preventDefault();try{const m=await rR(xa,f.email,f.password);await Ry($s(ln,"users",m.user.uid),{uid:m.user.uid,email:m.user.email,role:"member",name:m.user.email.split("@")[0],createdAt:Mn()}),p({email:"",password:""}),alert("Signup successful. Ask admin to promote you if needed.")}catch(m){alert("Signup failed: "+m.message)}}async function w(){await aR(xa)}async function R(){if((n==null?void 0:n.role)!=="admin")return alert("Only admin can create projects");if(!k.name||!k.assignedTo)return alert("Fill name and assignedTo");await DN(Vs(ln,"projects"),{...k,progress:0,status:"in progress",feedback:"",editHistory:[{id:ky(),user:n.email,field:"created",oldValue:"N/A",newValue:"created",ts:Mn()}],createdAt:Mn(),updatedAt:Mn()}),A(!1),D({name:"",description:"",assignedTo:"",deadline:"",resources:""})}async function x(y,m,v){const E={[m]:v,updatedAt:Mn()};try{const I=$s(ln,"projects",y),C=await Ay(I),T=C.exists()?C.data():{},Ne={id:ky(),user:(n==null?void 0:n.email)||"unknown",field:m,oldValue:String(T[m]??"N/A").slice(0,200),newValue:String(v).slice(0,200),ts:Mn()},Ot=[...T.editHistory||[],Ne];await kN(I,{...E,editHistory:Ot})}catch(I){console.error("updateProjectField error",I),alert("Update failed: "+(I.message||I))}}async function U(y){if((n==null?void 0:n.role)!=="admin")return alert("Only admin can delete");confirm("Delete project?")&&await NN($s(ln,"projects",y))}function j(y){const m=i.find(v=>v.id===y);return m?m.name||m.email:y}return t?M.jsx("div",{className:"min-h-screen p-6 bg-gray-50",children:M.jsxs("div",{className:"max-w-6xl mx-auto",children:[M.jsxs("header",{className:"bg-white rounded p-4 flex items-center justify-between mb-6 shadow-sm",children:[M.jsxs("div",{className:"flex items-center gap-3",children:[M.jsx("img",{src:Py,alt:"TII",className:"h-12"}),M.jsxs("div",{children:[M.jsx("h1",{className:"text-xl font-bold",children:"TII Project Management"}),M.jsx("p",{className:"text-sm text-gray-600",children:"Shared projects — real-time"})]})]}),M.jsxs("div",{className:"flex items-center gap-3",children:[M.jsx("div",{className:"text-sm text-gray-700",children:n==null?void 0:n.email}),M.jsx("button",{className:"px-3 py-2 border rounded",onClick:w,children:"Logout"})]})]}),M.jsxs("main",{children:[M.jsxs("div",{className:"mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3",children:[M.jsx("div",{className:"flex items-center gap-3",children:M.jsx("input",{placeholder:"Search projects...",className:"p-2 border rounded",onChange:y=>{}})}),M.jsx("div",{className:"flex items-center gap-3",children:(n==null?void 0:n.role)==="admin"&&M.jsx("button",{className:"px-3 py-2 bg-green-600 text-white rounded",onClick:()=>A(!0),children:"➕ Add Project"})})]}),u?M.jsx("div",{children:"Loading projects…"}):o.length===0?M.jsx("div",{className:"p-6 bg-white rounded text-center",children:"No projects"}):M.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:o.map(y=>{const m=VN(y.deadline),v=m==null?"border-gray-200":m<0?"border-red-300":m<=3?"border-yellow-300":"border-green-200";return M.jsxs("div",{className:`bg-white rounded p-4 border ${v} shadow`,children:[M.jsxs("div",{className:"flex justify-between items-start",children:[M.jsxs("div",{children:[M.jsx("h3",{className:"text-lg font-semibold",children:y.name}),M.jsxs("div",{className:"text-xs text-gray-500",children:["Assigned to: ",M.jsx("strong",{children:j(y.assignedTo)})]}),M.jsxs("div",{className:"text-xs text-gray-500",children:["Deadline: ",M.jsx("strong",{children:y.deadline||"—"})]})]}),M.jsxs("div",{className:"text-right",children:[M.jsxs("div",{className:"text-sm text-gray-500",children:[y.progress??0,"%"]}),M.jsx("div",{className:"text-xs text-gray-400",children:new Date(y.updatedAt||y.createdAt||Mn()).toLocaleString()})]})]}),M.jsx("div",{className:"mt-3 text-sm text-gray-700",children:y.description}),M.jsxs("div",{className:"mt-3",children:[M.jsx("label",{className:"font-semibold text-sm",children:"Resources"}),(n==null?void 0:n.role)==="admin"?M.jsx("textarea",{className:"w-full p-2 border rounded",defaultValue:y.resources,onBlur:E=>x(y.id,"resources",E.target.value)}):M.jsx(ON,{content:y.resources})]}),M.jsxs("div",{className:"mt-3",children:[M.jsx("label",{className:"font-semibold text-sm block mb-1",children:"Progress"}),M.jsx("input",{type:"range",min:"0",max:"100",defaultValue:y.progress??0,onChange:E=>{x(y.id,"progress",parseInt(E.target.value))},className:"w-full"})]}),M.jsxs("div",{className:"mt-3",children:[M.jsx("label",{className:"font-semibold text-sm",children:"Status"}),M.jsxs("select",{className:"w-full p-2 border rounded",value:y.status||"in progress",onChange:E=>x(y.id,"status",E.target.value),children:[M.jsx("option",{value:"in progress",children:"in progress"}),M.jsx("option",{value:"completed",children:"completed"}),M.jsx("option",{value:"paused",children:"paused"}),M.jsx("option",{value:"terminated",children:"terminated"})]})]}),M.jsxs("div",{className:"mt-3",children:[M.jsx("label",{className:"font-semibold text-sm",children:"Feedback / Comments"}),M.jsx("textarea",{className:"w-full p-2 border rounded",defaultValue:y.feedback||"",onBlur:E=>x(y.id,"feedback",E.target.value)})]}),M.jsx("div",{className:"mt-3",children:m!=null&&M.jsx("div",{className:"text-sm",children:m<0?M.jsxs("span",{className:"text-red-600 font-semibold",children:["Overdue by ",Math.abs(m)," day(s)"]}):m<=3?M.jsxs("span",{className:"text-yellow-700 font-semibold",children:["Reminder: ",m," day(s) left"]}):M.jsxs("span",{className:"text-green-700",children:[m," day(s) left"]})})}),M.jsx("div",{className:"mt-3 flex gap-2 items-center",children:(n==null?void 0:n.role)==="admin"&&M.jsxs(M.Fragment,{children:[M.jsx("button",{className:"py-1 px-3 bg-red-600 text-white rounded",onClick:()=>U(y.id),children:"Delete"}),M.jsxs("div",{className:"text-xs text-gray-500 ml-auto",children:["Edits: ",(y.editHistory||[]).length]})]})}),(n==null?void 0:n.role)==="admin"&&(y.editHistory||[]).length>0&&M.jsxs("div",{className:"mt-3 bg-gray-50 p-2 rounded text-xs",children:[M.jsx("strong",{children:"Edit history"}),M.jsx("div",{className:"max-h-40 overflow-y-auto mt-2",children:(y.editHistory||[]).slice().reverse().map(E=>M.jsxs("div",{className:"border-b py-1",children:[M.jsxs("div",{className:"font-semibold text-xs",children:[E.user," • ",E.field," • ",new Date(E.ts).toLocaleString()]}),M.jsxs("div",{className:"text-xs text-gray-500",children:[E.oldValue," → ",E.newValue]})]},E.id))})]})]},y.id)})}),_&&(n==null?void 0:n.role)==="admin"&&M.jsx("div",{className:"fixed inset-0 bg-black/40 flex items-center justify-center z-50",onClick:y=>{y.target===y.currentTarget&&A(!1)},children:M.jsxs("div",{className:"bg-white p-6 rounded max-w-lg w-full",children:[M.jsx("h3",{className:"text-lg font-semibold mb-3",children:"Add New Project"}),M.jsx("input",{className:"w-full p-2 border rounded mb-2",placeholder:"Project name",value:k.name,onChange:y=>D(m=>({...m,name:y.target.value}))}),M.jsx("textarea",{className:"w-full p-2 border rounded mb-2",placeholder:"Description",value:k.description,onChange:y=>D(m=>({...m,description:y.target.value}))}),M.jsx("label",{className:"text-sm font-semibold",children:"Assign to user"}),M.jsxs("select",{className:"w-full p-2 border rounded mb-2",value:k.assignedTo,onChange:y=>D(m=>({...m,assignedTo:y.target.value})),children:[M.jsx("option",{value:"",children:"Select user"}),i.map(y=>M.jsx("option",{value:y.id,children:y.name||y.email},y.id))]}),M.jsx("input",{className:"w-full p-2 border rounded mb-2",placeholder:"Deadline (YYYY-MM-DD)",value:k.deadline,onChange:y=>D(m=>({...m,deadline:y.target.value}))}),M.jsx("textarea",{className:"w-full p-2 border rounded mb-2",placeholder:"Resources (one per line or links)",value:k.resources,onChange:y=>D(m=>({...m,resources:y.target.value}))}),M.jsxs("div",{className:"flex gap-2",children:[M.jsx("button",{className:"flex-1 py-2 bg-green-600 text-white rounded",onClick:R,children:"Create"}),M.jsx("button",{className:"flex-1 py-2 border rounded",onClick:()=>A(!1),children:"Cancel"})]})]})})]})]})}):M.jsx("div",{className:"min-h-screen p-6 flex items-center justify-center",children:M.jsxs("div",{className:"w-full max-w-md bg-white rounded shadow p-6",children:[M.jsxs("div",{className:"flex items-center gap-3 mb-4",children:[M.jsx("img",{src:Py,alt:"TII",className:"h-12"}),M.jsxs("div",{children:[M.jsx("h1",{className:"text-xl font-bold",children:"TII Project Management"}),M.jsx("p",{className:"text-sm text-gray-600",children:"Sign in to access your projects"})]})]}),M.jsxs("form",{onSubmit:L,className:"flex flex-col gap-3",children:[M.jsx("input",{className:"border p-2 rounded",placeholder:"Email",value:f.email,onChange:y=>p(m=>({...m,email:y.target.value}))}),M.jsx("input",{className:"border p-2 rounded",placeholder:"Password",type:"password",value:f.password,onChange:y=>p(m=>({...m,password:y.target.value}))}),M.jsxs("div",{className:"flex gap-2",children:[M.jsx("button",{type:"submit",className:"flex-1 py-2 bg-orange-600 text-white rounded",children:"Login"}),M.jsx("button",{type:"button",className:"flex-1 py-2 border rounded",onClick:S,children:"Sign up"})]})]})]})})}Bv(document.getElementById("root")).render(M.jsx(uI.StrictMode,{children:M.jsx(LN,{})}));
